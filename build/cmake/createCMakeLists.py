...
def writeCMakeListsTop(dir):
    ...
    fo.write("  get_filename_component(X11_INSTALL_PREFIX ${X11_X11_LIB} DIRECTORY)\n")
    fo.write("endif()\n")
    ...
    fo.write('message("X11_INSTALL_PREFIX: ${X11_INSTALL_PREFIX}")\n')
...
def writeCMakeListsApp(appName, appDir, appCompileFileList,
    ...
    fo.write("if (DEFINED X11_INSTALL_PREFIX)\n")
    fo.write("  link_directories (${X11_INSTALL_PREFIX}/lib)\n")
    fo.write("endif()\n")
    fo.write("if (DEFINED netCDF_INSTALL_PREFIX)\n")
