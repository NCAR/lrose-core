...
int main(int argc, char *argv[]){
	...
	create_file(doradeFile,time,"test_swp.dorade");
...
void build_header(RayFile &file,RaycTime &startTime) throw (Fault &){
	...
	/*file.set_integer("binary_format",  1,(int)RayConst::binaryFormat4ByteFloat); */
	...
	file.set_double ("parameter_scale",0,100);
	file.set_double ("parameter_bias" ,0,0);

	file.set_double ("parameter_scale",1,100);
	file.set_double ("parameter_bias" ,1,0);

	file.set_double ("parameter_scale",2,100);
	file.set_double ("parameter_bias" ,2,0);

	file.set_double ("parameter_scale",3,100);
	file.set_double ("parameter_bias" ,3,0);

	file.set_double ("parameter_scale",4,1);
	file.set_double ("parameter_bias" ,4,0);
