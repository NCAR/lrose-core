   ...
   */
  virtual MathUserData *processUserLoop2dFunction(const UnaryNode &p) = 0;
  ...
  virtual std::vector<std::pair<std::string, std::string> > userUnaryOperators(void) const = 0;
   ...
   * @param[in] p  The unary node
   */
  virtual MathUserData *processUserLoop2dFunction(const UnaryNode &p);
  ...
  virtual std::vector<std::pair<std::string, std::string> > userUnaryOperators(void) const;
