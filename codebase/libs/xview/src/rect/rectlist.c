...
static void _rl_appendrect(register struct rect *r, 
...
static void _rl_difrects(register struct rect *r1, 
                         register struct rect *r2,
                         register struct rectlist *rl);

static int _rl_equal(register struct rectlist *rl1, register struct rectlist *rl2);

void _rl_freerectnode(register struct rectnode *rn);

static void _rl_removerect(register struct rect *r,
                           register struct rectlist *rl);

static void _rl_union(register struct rectlist *rlBase, register struct rectlist *rlAdd);


static struct rectnode **_rl_removerectnode(struct rectlist *rl,
                                            struct rectnode **rnPtr);

static void _rl_replacernbyrl(register struct rectlist *rlBase,
...
void _rl_replacernbyrl(rlBase, rnAxe, rlAdd)
