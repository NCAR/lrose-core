...
static
  copy_pieces(register ft_handle to_table, int to_index,
              register ft_handle from_table, int first, int last_plus_one);

static int
  get_current_offset(register Piece_table private);
