 ...
 * pair.
 */
#define	ATTR_TYPE(base_type, cardinality) (Attr_attribute) \
 ...
 */
#define	ATTR(pkg, type, ordinal) (Attr_attribute)	\
...
OPENWIN_VIEW_CLASS * subdivided as follows:
...
#define attr_cu_to_x(encoded_value, font, left_margin) 		\
    attr_rc_unit_to_x(encoded_value, xv_get(font, FONT_DEFAULT_CHAR_WIDTH), left_margin, NULL)
...
EXTERN_FUNCTION (Attr_avlist attr_copy_avlist, (Attr_avlist dest, Attr_avlist avlist));
