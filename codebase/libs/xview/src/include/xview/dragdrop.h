...
typedef enum {
  ...
  __DND_TYPE			= DND_ATTR(ATTR_SHORT,		1),
  __DND_CURSOR			= DND_ATTR(ATTR_OPAQUE,		5),
  __DND_X_CURSOR			= DND_ATTR(ATTR_LONG,		10),
  __DND_ACCEPT_CURSOR		= DND_ATTR(ATTR_OPAQUE,		15),
  __DND_ACCEPT_X_CURSOR		= DND_ATTR(ATTR_LONG,		20),
  __DND_TIMEOUT_VALUE		= DND_ATTR(ATTR_LONG,		25),
  /* Private Drop Site Item attrs */
  __DROP_SITE_SIZE			= DND_ATTR(ATTR_INT,		95),
  /* Public Drop Site Item attrs */
#ifdef WINDOW_SITES
  __DROP_SITE_TYPE			= DND_ATTR(ATTR_INT,		100),
#endif /* WINDOW_SITES */
  __DROP_SITE_ID			= DND_ATTR(ATTR_LONG,		105),
  __DROP_SITE_EVENT_MASK		= DND_ATTR(ATTR_INT,		110),
  __DROP_SITE_REGION		= DND_ATTR(ATTR_OPAQUE,		115),
  __DROP_SITE_REGION_PTR		= DND_ATTR(ATTR_OPAQUE, 	120),
  __DROP_SITE_DELETE_REGION		= DND_ATTR(ATTR_OPAQUE,		125),
  __DROP_SITE_DELETE_REGION_PTR	= DND_ATTR(ATTR_OPAQUE, 	130),
  __DROP_SITE_DEFAULT		= DND_ATTR(ATTR_BOOLEAN,	135)
} Dnd_attribute;

#define DND_TYPE ((Attr_attribute) __DND_TYPE)
#define DND_CURSOR ((Attr_attribute) __DND_CURSOR)
#define DND_X_CURSOR ((Attr_attribute) __DND_X_CURSOR)
#define DND_ACCEPT_CURSOR ((Attr_attribute) __DND_ACCEPT_CURSOR)
#define DND_ACCEPT_X_CURSOR ((Attr_attribute) __DND_ACCEPT_X_CURSOR)
#define DND_TIMEOUT_VALUE ((Attr_attribute) __DND_TIMEOUT_VALUE)
#define DROP_SITE_SIZE ((Attr_attribute) __DROP_SITE_SIZE)
#ifdef WINDOW_SITES
#define DROP_SITE_TYPE ((Attr_attribute) __DROP_SITE_TYPE)
#endif
#define DROP_SITE_ID ((Attr_attribute) __DROP_SITE_ID)
#define DROP_SITE_EVENT_MASK ((Attr_attribute) __DROP_SITE_EVENT_MASK)
#define DROP_SITE_REGION ((Attr_attribute) __DROP_SITE_REGION)
#define DROP_SITE_REGION_PTR ((Attr_attribute) __DROP_SITE_REGION_PTR)
#define DROP_SITE_DELETE_REGION ((Attr_attribute) __DROP_SITE_DELETE_REGION)
#define DROP_SITE_DELETE_REGION_PTR ((Attr_attribute) __DROP_SITE_DELETE_REGION_PTR)
#define DROP_SITE_DEFAULT ((Attr_attribute) __DROP_SITE_DEFAULT)
