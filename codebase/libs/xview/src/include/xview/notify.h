...
/* typedef int ucontext_t; DIXON - does not seem necessary any more 
 * replaced by including <sys/ucontext.h> */
#include <sys/ucontext.h>
#endif
...
#else
EXTERN_FUNCTION (Notify_value 	notify_default_wait3, (Notify_client nclient, int pid, union_wait_t *status, struct rusage *rusage));
#endif 
...
#else
EXTERN_FUNCTION (Notify_value 	notify_next_wait3_func, (Notify_client nclient, int pid, union_wait_t *status, struct rusage *rusage));
#endif 
