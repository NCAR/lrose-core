...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("MaliSat2Mdv");
    tt->comment_text = tdrpStrDup("This program converts the Mali satellite netCDF files into MDV format.");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("mdvp:://localhost::mdv/tpw");
    tt++;
    ...
    tt->param_name = tdrpStrDup("input_grid");
    tt->descr = tdrpStrDup("Input grid information");
    tt->help = tdrpStrDup("\tgrid_dx - Grid resolution in the X direction in degrees.\n\tgrid_dy - Grid resolution in the Y direction in degrees.\n");
    tt->val_offset = (char *) &input_grid - &_start_;
    tt->struct_def.name = tdrpStrDup("grid_t");
    tt->struct_def.nfields = 2;
    tt->struct_def.fields = (struct_field_t *)
        tdrpMalloc(tt->struct_def.nfields * sizeof(struct_field_t));
      tt->struct_def.fields[0].ftype = tdrpStrDup("double");
      tt->struct_def.fields[0].fname = tdrpStrDup("grid_dx");
      tt->struct_def.fields[0].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[0].rel_offset = 
        (char *) &input_grid.grid_dx - (char *) &input_grid;
      tt->struct_def.fields[1].ftype = tdrpStrDup("double");
      tt->struct_def.fields[1].fname = tdrpStrDup("grid_dy");
      tt->struct_def.fields[1].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &input_grid.grid_dy - (char *) &input_grid;
    tt->n_struct_vals = 2;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].d = 0.1;
      tt->struct_vals[1].d = 0.1;
    tt++;
