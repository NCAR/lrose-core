...
public:
  ...
  char* *_field_names_unsmoothed;
  int field_names_unsmoothed_n;

  char* *_field_names_smoothed;
  int field_names_smoothed_n;
  ...
  float current_weighting_factor;

  float past_weight_slope;
