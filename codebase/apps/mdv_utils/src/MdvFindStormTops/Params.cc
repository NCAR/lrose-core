...
//
// Code for program MdvFindStormTops
//
...
#include <cstring>
...

  {
    ...
    tt->help = tdrpStrDup("This is the field operations are performed on.");
    tt->val_offset = (char *) &inFieldName - &_start_;
    tt->single_val.s = tdrpStrDup("counts3D");
    tt++;
    ...
    tt->help = tdrpStrDup("Data values must exceed this to be considered the top of the storm.");
    ...
    tt->help = tdrpStrDup("Will be the same as the heights of the planes in the input 3D volume.");
    tt->val_offset = (char *) &heightUnits - &_start_;
    tt->single_val.s = tdrpStrDup("Km");
    tt++;
    
    // Parameter 'doTranslation'
    // ctype is 'tdrp_bool_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = BOOL_TYPE;
    tt->param_name = tdrpStrDup("doTranslation");
    tt->descr = tdrpStrDup("Option to do a substitution on output values\ntaken from the vlevel header to change units.");
    tt->help = tdrpStrDup("Uses transTable parameter.");
    tt->val_offset = (char *) &doTranslation - &_start_;
    tt->single_val.b = pFALSE;
    tt++;
    
    // Parameter 'transTable'
    // ctype is '_transTable_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRUCT_TYPE;
    tt->param_name = tdrpStrDup("transTable");
    tt->descr = tdrpStrDup("If the option to do a substitution on output values\ntaken from the vlevel header to change units is used, it is done\nwith this table.");
    tt->help = tdrpStrDup("If a value is greater than a minimum value, and\nless than or equal to a maximum value, it is replaced by the\nsubsVal (substitution value). The default would roughly map\nKm to m for calculated Km values of 1, 2 and 3 Km.");
    tt->array_offset = (char *) &_transTable - &_start_;
    tt->array_n_offset = (char *) &transTable_n - &_start_;
    tt->is_array = TRUE;
    tt->array_len_fixed = FALSE;
    tt->array_elem_size = sizeof(transTable_t);
    tt->array_n = 3;
    tt->struct_def.name = tdrpStrDup("transTable_t");
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        (char *) &_transTable->minVal - (char *) _transTable;
      tt->struct_def.fields[1].ftype = tdrpStrDup("double");
      tt->struct_def.fields[1].fname = tdrpStrDup("maxVal");
      tt->struct_def.fields[1].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &_transTable->maxVal - (char *) _transTable;
      tt->struct_def.fields[2].ftype = tdrpStrDup("double");
      tt->struct_def.fields[2].fname = tdrpStrDup("subsVal");
      tt->struct_def.fields[2].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[2].rel_offset = 
        (char *) &_transTable->subsVal - (char *) _transTable;
    tt->n_struct_vals = 9;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].d = 0.9;
      tt->struct_vals[1].d = 1.1;
      tt->struct_vals[2].d = 1000;
      tt->struct_vals[3].d = 1.9;
      tt->struct_vals[4].d = 2.1;
      tt->struct_vals[5].d = 2000;
      tt->struct_vals[6].d = 2.9;
      tt->struct_vals[7].d = 3.1;
      tt->struct_vals[8].d = 3000;
    tt++;
