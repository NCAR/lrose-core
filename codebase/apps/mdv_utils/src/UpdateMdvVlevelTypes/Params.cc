...
//
// Code for program UpdateMdvVlevelTypes
//
...
#include <cstring>
...

  {
    ...
    // Parameter 'new_vlevel_type'
    // ctype is '_vlevel_type_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = ENUM_TYPE;
    tt->param_name = tdrpStrDup("new_vlevel_type");
    tt->descr = tdrpStrDup("New type to use for the vlevel_type in both the master header and the field headers.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &new_vlevel_type - &_start_;
    ...
    tt->enum_def.fields = (enum_field_t *)
      ...
      tt->enum_def.fields[1].name = tdrpStrDup("VERT_TYPE_SIGMA_P");
      tt->enum_def.fields[1].val = VERT_TYPE_SIGMA_P;
      tt->enum_def.fields[2].name = tdrpStrDup("VERT_TYPE_PRESSURE");
      tt->enum_def.fields[2].val = VERT_TYPE_PRESSURE;
      tt->enum_def.fields[3].name = tdrpStrDup("VERT_TYPE_Z");
      tt->enum_def.fields[3].val = VERT_TYPE_Z;
      tt->enum_def.fields[4].name = tdrpStrDup("VERT_TYPE_SIGMA_Z");
      tt->enum_def.fields[4].val = VERT_TYPE_SIGMA_Z;
      tt->enum_def.fields[5].name = tdrpStrDup("VERT_TYPE_ETA");
      tt->enum_def.fields[5].val = VERT_TYPE_ETA;
      tt->enum_def.fields[6].name = tdrpStrDup("VERT_TYPE_THETA");
      tt->enum_def.fields[6].val = VERT_TYPE_THETA;
      tt->enum_def.fields[7].name = tdrpStrDup("VERT_TYPE_MIXED");
      tt->enum_def.fields[7].val = VERT_TYPE_MIXED;
      tt->enum_def.fields[8].name = tdrpStrDup("VERT_TYPE_ELEV");
      tt->enum_def.fields[8].val = VERT_TYPE_ELEV;
      tt->enum_def.fields[9].name = tdrpStrDup("VERT_TYPE_COMPOSITE");
      tt->enum_def.fields[9].val = VERT_TYPE_COMPOSITE;
      tt->enum_def.fields[10].name = tdrpStrDup("VERT_TYPE_CROSS_SEC");
      tt->enum_def.fields[10].val = VERT_TYPE_CROSS_SEC;
      tt->enum_def.fields[11].name = tdrpStrDup("VERT_SATELLITE_IMAGE");
      tt->enum_def.fields[11].val = VERT_SATELLITE_IMAGE;
      tt->enum_def.fields[12].name = tdrpStrDup("VERT_VARIABLE_ELEV");
      tt->enum_def.fields[12].val = VERT_VARIABLE_ELEV;
      tt->enum_def.fields[13].name = tdrpStrDup("VERT_FIELDS_VAR_ELEV");
      tt->enum_def.fields[13].val = VERT_FIELDS_VAR_ELEV;
      tt->enum_def.fields[14].name = tdrpStrDup("VERT_FLIGHT_LEVEL");
      tt->enum_def.fields[14].val = VERT_FLIGHT_LEVEL;
      tt->enum_def.fields[15].name = tdrpStrDup("VERT_EARTH_IMAGE");
      tt->enum_def.fields[15].val = VERT_EARTH_IMAGE;
      tt->enum_def.fields[16].name = tdrpStrDup("VERT_TYPE_AZ");
      tt->enum_def.fields[16].val = VERT_TYPE_AZ;
