...
//
// Code for program MdvFromCircles
//
...
#include <cstring>
...

  {
    ...
    tt->single_val.s = tdrpStrDup("$(RAP_DATA_DIR)/$(PROJECT)/other/circleFiles");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup(".cir");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("mdvp:://localhost::$(PROJECT)/mdv/fromCircles");
    tt++;
    ...
    // Parameter 'lowerLeftLat'
    // ctype is 'double'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = DOUBLE_TYPE;
    tt->param_name = tdrpStrDup("lowerLeftLat");
    tt->descr = tdrpStrDup("Lower left latitude for lat/lon grid.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &lowerLeftLat - &_start_;
    tt->single_val.d = 37;
    tt++;
    
    // Parameter 'lowerLeftLon'
    // ctype is 'double'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = DOUBLE_TYPE;
    tt->param_name = tdrpStrDup("lowerLeftLon");
    tt->descr = tdrpStrDup("Lower left longitude for lat/lon grid.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &lowerLeftLon - &_start_;
    tt->single_val.d = -109;
    tt++;
    ...
    tt->descr = tdrpStrDup("Number of points in longitude for lat/lon grid.");
    tt->help = tdrpStrDup("");
    ...
    tt->descr = tdrpStrDup("Number of points in latitude for lat/lon grid.");
    tt->help = tdrpStrDup("");
    ...
    tt->descr = tdrpStrDup("Stepsize in Longitude, degrees, for lat/lon grid.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &Dx - &_start_;
    tt->single_val.d = 0.00833333;
    tt++;
    ...
    tt->descr = tdrpStrDup("Stepsize in Latitude, degrees, for lat/lon grid.");
    tt->help = tdrpStrDup("");
    ...
    tt->descr = tdrpStrDup("Field name for output MDV field.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &FieldName - &_start_;
    tt->single_val.s = tdrpStrDup("Interest");
    tt++;
    
    // Parameter 'FieldUnits'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("FieldUnits");
    tt->descr = tdrpStrDup("Field units for output MDV field.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &FieldUnits - &_start_;
    tt->single_val.s = tdrpStrDup("Percent");
    tt++;
    
    // Parameter 'replaceZeroWithMissing'
    // ctype is 'tdrp_bool_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = BOOL_TYPE;
    tt->param_name = tdrpStrDup("replaceZeroWithMissing");
    tt->descr = tdrpStrDup("Set to TRUE to replace 0.0 with missing.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &replaceZeroWithMissing - &_start_;
    tt->single_val.b = pFALSE;
    tt++;
