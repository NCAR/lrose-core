...
//
// Code for program MdvFillMissing
//
...
#include <cstring>
...

  {
    ...
    tt->help = tdrpStrDup("Program runs on data stored here.");
    ...
    tt->single_val.s = tdrpStrDup("mdvp:://localhost::mdv/filled");
    tt++;
    ...
    tt->help = tdrpStrDup("Can use short or long field name.");
    ...
    // Parameter 'MissingReplaceValue'
    // ctype is 'double'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = DOUBLE_TYPE;
    tt->param_name = tdrpStrDup("MissingReplaceValue");
    tt->descr = tdrpStrDup("Value to replace missing data with.");
    tt->help = tdrpStrDup("Data can be marked BAD or MISSING - in many cases the two are\nequivalent. When this program encounters MISSING data it will\nreplace them with this value. Often BadReplaceValue is equal to MissingReplaceValue.");
    tt->val_offset = (char *) &MissingReplaceValue - &_start_;
    tt->single_val.d = 0;
    tt++;
    
    // Parameter 'BadReplaceValue'
    // ctype is 'double'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = DOUBLE_TYPE;
    tt->param_name = tdrpStrDup("BadReplaceValue");
    tt->descr = tdrpStrDup("Value to replace bad data with.");
    tt->help = tdrpStrDup("Data can be marked BAD or MISSING - in many cases the two are\nequivalent. When this program encounters BAD data it will\nreplace them with this value. Often BadReplaceValue is equal to MissingReplaceValue.");
    tt->val_offset = (char *) &BadReplaceValue - &_start_;
    tt->single_val.d = 0;
    tt++;
