...
public:
  ...
  filename_time_t filename_time;

  int n_fields;

  row_ordering_t input_row_ordering;

  encoding_type_t input_encoding;

  tdrp_bool_t byte_swap_input_data;

  projection_t grid_projection;

  grid_size_t grid_size;

  grid_geom_t grid_geom;
  ...
  double polar_stereo_tangent_lon;
