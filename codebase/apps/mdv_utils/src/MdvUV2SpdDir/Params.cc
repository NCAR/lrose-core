...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("MdvUV2SpdDir reads U and V component winds and\nproduces speed and direction fields which are written\nto another URL.\n\nNiles Oien June 2005.");
    ...
    tt->descr = tdrpStrDup("Input U component field name.");
    tt->help = tdrpStrDup("Use PrintMdv to ascertain. Output fields are speed and dir.");
    ...
    tt->descr = tdrpStrDup("Input V component field name.");
    tt->help = tdrpStrDup("Use PrintMdv to ascertain. Output fields are speed and dir.");
    ...
    tt->descr = tdrpStrDup("Option to write output in forecast mode.");
    tt->help = tdrpStrDup("Defaults to FALSE");
