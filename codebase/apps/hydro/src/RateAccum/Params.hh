...
public:
  ...
  running_accum_t *_running_accums;
  int running_accums_n;

  restart_time_of_day_t *_restart_time_of_day;
  int restart_time_of_day_n;

  char* tod_accum_output_url;

  char* total_accum_output_url;

  double max_precip_depth;

  double min_precip_depth;
