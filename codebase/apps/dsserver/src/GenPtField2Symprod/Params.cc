...
//
// Code for program GenPtField2Symprod
//
...
#include <cstring>
...

  {
    ...
    tt->descr = tdrpStrDup("Field name to display.");
    tt->help = tdrpStrDup("This must appear exactly as it appears in the SPDB database.");
    ...
    tt->param_name = tdrpStrDup("multiplier");
    tt->descr = tdrpStrDup("Data value multiplier.");
    tt->help = tdrpStrDup("The data value in the SPDB database will be multiplied by this factor to determine the value to display.  This is included so you can change units for display.");
    tt->val_offset = (char *) &multiplier - &_start_;
    tt->single_val.d = 1;
    tt++;
    
    // Parameter 'text_values'
    // ctype is '_text_values_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRUCT_TYPE;
    tt->param_name = tdrpStrDup("text_values");
    tt->descr = tdrpStrDup("Information about how to render data values that are rendered as text.");
    tt->help = tdrpStrDup("Data values between the min_value (inclusive) and max_value (exclusive) after multiplying by the multiplier will be rendered textually as indicated. If a data value falls within more than one given range, the first range it falls in will be used.If a data value falls within both a text range and an icon range, it will be rendered as text.");
    tt->array_offset = (char *) &_text_values - &_start_;
    tt->array_n_offset = (char *) &text_values_n - &_start_;
    tt->is_array = TRUE;
    tt->array_len_fixed = FALSE;
    tt->array_elem_size = sizeof(text_values_t);
    tt->array_n = 1;
    tt->struct_def.name = tdrpStrDup("text_values_t");
    tt->struct_def.nfields = 12;
    tt->struct_def.fields = (struct_field_t *)
        tdrpMalloc(tt->struct_def.nfields * sizeof(struct_field_t));
      tt->struct_def.fields[0].ftype = tdrpStrDup("double");
      tt->struct_def.fields[0].fname = tdrpStrDup("min_value");
      tt->struct_def.fields[0].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[0].rel_offset = 
        (char *) &_text_values->min_value - (char *) _text_values;
      tt->struct_def.fields[1].ftype = tdrpStrDup("double");
      tt->struct_def.fields[1].fname = tdrpStrDup("max_value");
      tt->struct_def.fields[1].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &_text_values->max_value - (char *) _text_values;
      tt->struct_def.fields[2].ftype = tdrpStrDup("string");
      tt->struct_def.fields[2].fname = tdrpStrDup("value_format_string");
      tt->struct_def.fields[2].ptype = STRING_TYPE;
      tt->struct_def.fields[2].rel_offset = 
        (char *) &_text_values->value_format_string - (char *) _text_values;
      tt->struct_def.fields[3].ftype = tdrpStrDup("string");
      tt->struct_def.fields[3].fname = tdrpStrDup("font_name");
      tt->struct_def.fields[3].ptype = STRING_TYPE;
      tt->struct_def.fields[3].rel_offset = 
        (char *) &_text_values->font_name - (char *) _text_values;
      tt->struct_def.fields[4].ftype = tdrpStrDup("string");
      tt->struct_def.fields[4].fname = tdrpStrDup("color_name");
      tt->struct_def.fields[4].ptype = STRING_TYPE;
      tt->struct_def.fields[4].rel_offset = 
        (char *) &_text_values->color_name - (char *) _text_values;
      tt->struct_def.fields[5].ftype = tdrpStrDup("string");
      tt->struct_def.fields[5].fname = tdrpStrDup("background_color_name");
      tt->struct_def.fields[5].ptype = STRING_TYPE;
      tt->struct_def.fields[5].rel_offset = 
        (char *) &_text_values->background_color_name - (char *) _text_values;
      ...
      tt->struct_def.fields[6].rel_offset = 
        (char *) &_text_values->x_offset - (char *) _text_values;
      ...
      tt->struct_def.fields[7].rel_offset = 
        (char *) &_text_values->y_offset - (char *) _text_values;
      ...
      tt->struct_def.fields[8].rel_offset = 
        (char *) &_text_values->vert_align - (char *) _text_values;
      ...
      tt->struct_def.fields[9].rel_offset = 
        (char *) &_text_values->horiz_align - (char *) _text_values;
      ...
      tt->struct_def.fields[10].rel_offset = 
        (char *) &_text_values->font_size - (char *) _text_values;
      ...
      tt->struct_def.fields[11].rel_offset = 
        (char *) &_text_values->font_style - (char *) _text_values;
    ...
    tt->struct_vals = (tdrpVal_t *)
      ...
      tt->struct_vals[0].d = DBL_MIN;
      tt->struct_vals[1].d = DBL_MAX;
      tt->struct_vals[2].s = tdrpStrDup("%f");
      tt->struct_vals[3].s = tdrpStrDup("");
      tt->struct_vals[4].s = tdrpStrDup("red");
      tt->struct_vals[5].s = tdrpStrDup("");
      tt->struct_vals[6].l = 0;
    ...
    // Parameter 'icon_values'
    // ctype is '_icon_values_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRUCT_TYPE;
    tt->param_name = tdrpStrDup("icon_values");
    tt->descr = tdrpStrDup("Information about how to render data values that are rendered as icons.");
    tt->help = tdrpStrDup("Data values between the min_value (inclusive) and max_value (exclusive) after multiplying by the multiplier will be rendered as icons as indicated. If a data value falls within more than one given range, the first range it falls in will be used. If a data value falls within both a text range and an icon range, it will be rendered as text. The icon_name field must match one of the icon_name fields in the icon_defs array exactly.");
    tt->array_offset = (char *) &_icon_values - &_start_;
    tt->array_n_offset = (char *) &icon_values_n - &_start_;
    tt->is_array = TRUE;
    tt->array_len_fixed = FALSE;
    tt->array_elem_size = sizeof(icon_values_t);
    tt->array_n = 1;
    tt->struct_def.name = tdrpStrDup("icon_values_t");
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[0].rel_offset = 
        (char *) &_icon_values->min_value - (char *) _icon_values;
      tt->struct_def.fields[1].ftype = tdrpStrDup("double");
      tt->struct_def.fields[1].fname = tdrpStrDup("max_value");
      tt->struct_def.fields[1].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &_icon_values->max_value - (char *) _icon_values;
      tt->struct_def.fields[2].ftype = tdrpStrDup("string");
      tt->struct_def.fields[2].fname = tdrpStrDup("icon_name");
      tt->struct_def.fields[2].ptype = STRING_TYPE;
      tt->struct_def.fields[2].rel_offset = 
        (char *) &_icon_values->icon_name - (char *) _icon_values;
      tt->struct_def.fields[3].ftype = tdrpStrDup("string");
      tt->struct_def.fields[3].fname = tdrpStrDup("color_name");
      tt->struct_def.fields[3].ptype = STRING_TYPE;
      tt->struct_def.fields[3].rel_offset = 
        (char *) &_icon_values->color_name - (char *) _icon_values;
    tt->n_struct_vals = 4;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
