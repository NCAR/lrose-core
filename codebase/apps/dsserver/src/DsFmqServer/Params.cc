...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("FMQ SERVER");
    ...
    tt->descr = tdrpStrDup("Print debug messages");
    tt->help = tdrpStrDup("");
    ...
    tt->descr = tdrpStrDup("Print verbose debug messages");
    tt->help = tdrpStrDup("");
