...
//
// Code for program DsLdataServer
//
...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("DsServerMgr SUPPORT");
    tt->comment_text = tdrpStrDup("");
    tt++;
