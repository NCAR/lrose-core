...
//
// Code for program WxHazards2Symprod
//
...
#include <cstring>
...

  {
    ...
    // Parameter 'conv_region_color'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("conv_region_color");
    tt->descr = tdrpStrDup("Convective region hazard color.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &conv_region_color - &_start_;
    tt->single_val.s = tdrpStrDup("red");
    tt++;
    
    // Parameter 'conv_region_line_width'
    // ctype is 'long'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = LONG_TYPE;
    tt->param_name = tdrpStrDup("conv_region_line_width");
    tt->descr = tdrpStrDup("Convective region hazard line width.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &conv_region_line_width - &_start_;
    tt->has_min = TRUE;
    tt->min_val.l = 1;
    tt->single_val.l = 1;
    tt++;
