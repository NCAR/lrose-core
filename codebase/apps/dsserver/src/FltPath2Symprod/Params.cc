...
//
// Code for program FltPath2Symprod
//
...
#include <cstring>
...

  {
    ...
    tt->val_offset = (char *) &past_polyline_color - &_start_;
    ...
    tt->val_offset = (char *) &future_polyline_color - &_start_;
    ...
    tt->val_offset = (char *) &polyline_line_type - &_start_;
    ...
    tt->val_offset = (char *) &polyline_line_width - &_start_;
    tt->has_min = TRUE;
    tt->min_val.l = 1;
    tt->single_val.l = 1;
    tt++;
    ...
    tt->val_offset = (char *) &polyline_capstyle - &_start_;
    ...
    tt->val_offset = (char *) &polyline_join_style - &_start_;
    ...
    tt->val_offset = (char *) &curr_pos_icon_color - &_start_;
    tt->single_val.s = tdrpStrDup("green");
    tt++;
    ...
    tt->array_offset = (char *) &_curr_pos_icon - &_start_;
    tt->array_n_offset = (char *) &curr_pos_icon_n - &_start_;
    tt->is_array = TRUE;
