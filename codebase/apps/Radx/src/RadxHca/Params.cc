...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.fields[48].name = tdrpStrDup("GC_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[48].val = GC_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[49].name = tdrpStrDup("BS_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[49].val = BS_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[50].name = tdrpStrDup("DS_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[50].val = DS_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[51].name = tdrpStrDup("WS_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[51].val = WS_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[52].name = tdrpStrDup("CR_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[52].val = CR_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[53].name = tdrpStrDup("GR_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[53].val = GR_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[54].name = tdrpStrDup("BD_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[54].val = BD_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[55].name = tdrpStrDup("RA_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[55].val = RA_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[56].name = tdrpStrDup("HR_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[56].val = HR_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[57].name = tdrpStrDup("RH_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[57].val = RH_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[58].name = tdrpStrDup("HCA");
        tt->struct_def.fields[0].enum_def.fields[58].val = HCA;
