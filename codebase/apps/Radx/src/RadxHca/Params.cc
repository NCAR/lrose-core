...
#include <cstring>
...

  {
    ...
    tt->descr = tdrpStrDup("Length of kernel for computing SD_DBZ - gates.");
    tt->help = tdrpStrDup("SD_DBZ is the rms deviation of the DBZ field from a linear trend, over this number of gates.");
    tt->val_offset = (char *) &HCA_SD_DBZ_kernel_len - &_start_;
    tt->single_val.i = 5;
    tt++;
    
    // Parameter 'HCA_SD_PHIDP_kernel_len'
    // ctype is 'int'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = INT_TYPE;
    tt->param_name = tdrpStrDup("HCA_SD_PHIDP_kernel_len");
    tt->descr = tdrpStrDup("Length of kernel for computing SD_PHIDP - gates.");
    tt->help = tdrpStrDup("SD_PHIDP is the rms deviation of the PHIDP field from a linear trend, over this number of gates.");
    tt->val_offset = (char *) &HCA_SD_PHIDP_kernel_len - &_start_;
    tt->single_val.i = 11;
    tt++;
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.fields[46].name = tdrpStrDup("SD_DBZ2");
        tt->struct_def.fields[0].enum_def.fields[46].val = SD_DBZ2;
        tt->struct_def.fields[0].enum_def.fields[47].name = tdrpStrDup("SD_PHIDP");
        tt->struct_def.fields[0].enum_def.fields[47].val = SD_PHIDP;
        tt->struct_def.fields[0].enum_def.fields[48].name = tdrpStrDup("SD_PHIDP2");
        tt->struct_def.fields[0].enum_def.fields[48].val = SD_PHIDP2;
        tt->struct_def.fields[0].enum_def.fields[49].name = tdrpStrDup("GC_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[49].val = GC_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[50].name = tdrpStrDup("BS_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[50].val = BS_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[51].name = tdrpStrDup("DS_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[51].val = DS_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[52].name = tdrpStrDup("WS_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[52].val = WS_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[53].name = tdrpStrDup("CR_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[53].val = CR_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[54].name = tdrpStrDup("GR_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[54].val = GR_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[55].name = tdrpStrDup("BD_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[55].val = BD_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[56].name = tdrpStrDup("RA_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[56].val = RA_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[57].name = tdrpStrDup("HR_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[57].val = HR_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[58].name = tdrpStrDup("RH_INTEREST");
        tt->struct_def.fields[0].enum_def.fields[58].val = RH_INTEREST;
        tt->struct_def.fields[0].enum_def.fields[59].name = tdrpStrDup("HCA");
        tt->struct_def.fields[0].enum_def.fields[59].val = HCA;
