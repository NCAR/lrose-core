...
public:
  ...
  tdrp_bool_t correct_fixed_angles;

  double fixed_angle_offset;

  tdrp_bool_t correct_elevation_angles;

  double elevation_angle_offset;

  tdrp_bool_t correct_azimuth_angles;

  double azimuth_angle_offset;

  tdrp_bool_t correct_for_platform_orientation;

  georef_mode_t georef_mode;
  ...
  double platform_tilt_amount_deg;

  double platform_tilt_direction_deg;

  tdrp_bool_t tilt_direction_is_relative_to_north;
