...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.nfields = 50;
        ...
        tt->struct_def.fields[0].enum_def.fields[40].name = tdrpStrDup("WIDTH_MEAN_RLAN");
        tt->struct_def.fields[0].enum_def.fields[40].val = WIDTH_MEAN_RLAN;
        tt->struct_def.fields[0].enum_def.fields[41].name = tdrpStrDup("PHASE_RLAN");
        tt->struct_def.fields[0].enum_def.fields[41].val = PHASE_RLAN;
        tt->struct_def.fields[0].enum_def.fields[42].name = tdrpStrDup("PHASE_NOISE_RLAN");
        tt->struct_def.fields[0].enum_def.fields[42].val = PHASE_NOISE_RLAN;
        ...
        tt->struct_def.fields[0].enum_def.fields[46].name = tdrpStrDup("PHASE_NOISE_INTEREST_RLAN");
        tt->struct_def.fields[0].enum_def.fields[46].val = PHASE_NOISE_INTEREST_RLAN;
        tt->struct_def.fields[0].enum_def.fields[47].name = tdrpStrDup("NCP_MEAN_INTEREST_RLAN");
        tt->struct_def.fields[0].enum_def.fields[47].val = NCP_MEAN_INTEREST_RLAN;
        tt->struct_def.fields[0].enum_def.fields[48].name = tdrpStrDup("WIDTH_MEAN_INTEREST_RLAN");
        tt->struct_def.fields[0].enum_def.fields[48].val = WIDTH_MEAN_INTEREST_RLAN;
        tt->struct_def.fields[0].enum_def.fields[49].name = tdrpStrDup("SNR_DMODE_INTEREST_RLAN");
        tt->struct_def.fields[0].enum_def.fields[49].val = SNR_DMODE_INTEREST_RLAN;
