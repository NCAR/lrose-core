...
// AppParams.cc
//
// TDRP C++ code file for class 'AppParams'.
//
...
#include <cstring>
  ...
  AppParams::AppParams(const AppParams& source)
  ...
  void AppParams::operator=(const AppParams& other)
  ...
  int AppParams::loadFromArgs(int argc, char **argv,
                           char **override_list,
                           char **params_path_p,
                           bool defer_exit)
  {
  ...
  int AppParams::loadApplyArgs(const char *params_path,
                            int argc, char **argv,
                            char **override_list,
                            bool defer_exit)
  {
  ...
  bool AppParams::isArgValid(const char *arg)
  {
  ...
  int AppParams::isArgValidN(const char *arg)
  {
  ...
  int AppParams::load(const char *param_file_path,
                   char **override_list,
  ...
  int AppParams::loadFromBuf(const char *param_source_str,
                          char **override_list,
  ...
  int AppParams::loadDefaults(int expand_env)
  {
    if (tdrpLoad(NULL,
                 _table, &_start_,
  ...
  void AppParams::sync(void) const
  {
  ...
  void AppParams::print(FILE *out, tdrp_print_mode_t mode)
  {
  ...
  int AppParams::checkAllSet(FILE *out)
  {
  ...
  int AppParams::checkIsSet(const char *paramName)
  {
  ...
  void AppParams::usage(ostream &out)
  {
  ...
  int AppParams::arrayRealloc(const char *param_name, int new_array_n)
  {
  ...
  int AppParams::array2DRealloc(const char *param_name,
                             int new_array_n1,
                             int new_array_n2)
  {
