...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.nfields = 70;
        ...
        tt->struct_def.fields[0].enum_def.fields[59].name = tdrpStrDup("SNR_SDEV_RLAN");
        tt->struct_def.fields[0].enum_def.fields[59].val = SNR_SDEV_RLAN;
        tt->struct_def.fields[0].enum_def.fields[60].name = tdrpStrDup("ZDR_SDEV_RLAN");
        tt->struct_def.fields[0].enum_def.fields[60].val = ZDR_SDEV_RLAN;
        tt->struct_def.fields[0].enum_def.fields[61].name = tdrpStrDup("NCP_MEAN_RLAN");
        tt->struct_def.fields[0].enum_def.fields[61].val = NCP_MEAN_RLAN;
        tt->struct_def.fields[0].enum_def.fields[62].name = tdrpStrDup("PHASE_RLAN");
        tt->struct_def.fields[0].enum_def.fields[62].val = PHASE_RLAN;
        tt->struct_def.fields[0].enum_def.fields[63].name = tdrpStrDup("PHASE_CHANGE_RLAN");
        tt->struct_def.fields[0].enum_def.fields[63].val = PHASE_CHANGE_RLAN;
        tt->struct_def.fields[0].enum_def.fields[64].name = tdrpStrDup("ZDRM_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[64].val = ZDRM_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[65].name = tdrpStrDup("ZDRM_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[65].val = ZDRM_IN_BRAGG;
        tt->struct_def.fields[0].enum_def.fields[66].name = tdrpStrDup("ZDR_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[66].val = ZDR_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[67].name = tdrpStrDup("ZDR_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[67].val = ZDR_IN_BRAGG;
        tt->struct_def.fields[0].enum_def.fields[68].name = tdrpStrDup("ZDR_FLAG_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[68].val = ZDR_FLAG_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[69].name = tdrpStrDup("ZDR_FLAG_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[69].val = ZDR_FLAG_IN_BRAGG;
