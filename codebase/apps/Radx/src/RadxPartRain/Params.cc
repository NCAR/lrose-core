...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.nfields = 64;
        ...
        tt->struct_def.fields[0].enum_def.fields[11].name = tdrpStrDup("KDP_BRINGI");
        tt->struct_def.fields[0].enum_def.fields[11].val = KDP_BRINGI;
        ...
        tt->struct_def.fields[0].enum_def.fields[14].name = tdrpStrDup("PRECIP_RATE_ZH");
        tt->struct_def.fields[0].enum_def.fields[14].val = PRECIP_RATE_ZH;
        tt->struct_def.fields[0].enum_def.fields[15].name = tdrpStrDup("PRECIP_RATE_ZH_SNOW");
        tt->struct_def.fields[0].enum_def.fields[15].val = PRECIP_RATE_ZH_SNOW;
        tt->struct_def.fields[0].enum_def.fields[16].name = tdrpStrDup("PRECIP_RATE_Z_ZDR");
        tt->struct_def.fields[0].enum_def.fields[16].val = PRECIP_RATE_Z_ZDR;
        tt->struct_def.fields[0].enum_def.fields[17].name = tdrpStrDup("PRECIP_RATE_KDP");
        tt->struct_def.fields[0].enum_def.fields[17].val = PRECIP_RATE_KDP;
        tt->struct_def.fields[0].enum_def.fields[18].name = tdrpStrDup("PRECIP_RATE_KDP_ZDR");
        tt->struct_def.fields[0].enum_def.fields[18].val = PRECIP_RATE_KDP_ZDR;
        tt->struct_def.fields[0].enum_def.fields[19].name = tdrpStrDup("PRECIP_RATE_HYBRID");
        tt->struct_def.fields[0].enum_def.fields[19].val = PRECIP_RATE_HYBRID;
        tt->struct_def.fields[0].enum_def.fields[20].name = tdrpStrDup("PRECIP_RATE_PID");
        tt->struct_def.fields[0].enum_def.fields[20].val = PRECIP_RATE_PID;
        tt->struct_def.fields[0].enum_def.fields[21].name = tdrpStrDup("PRECIP_RATE_HIDRO");
        tt->struct_def.fields[0].enum_def.fields[21].val = PRECIP_RATE_HIDRO;
        tt->struct_def.fields[0].enum_def.fields[22].name = tdrpStrDup("PRECIP_RATE_BRINGI");
        tt->struct_def.fields[0].enum_def.fields[22].val = PRECIP_RATE_BRINGI;
        tt->struct_def.fields[0].enum_def.fields[23].name = tdrpStrDup("DBZ_ATTEN_CORRECTION");
        tt->struct_def.fields[0].enum_def.fields[23].val = DBZ_ATTEN_CORRECTION;
        tt->struct_def.fields[0].enum_def.fields[24].name = tdrpStrDup("ZDR_ATTEN_CORRECTION");
        tt->struct_def.fields[0].enum_def.fields[24].val = ZDR_ATTEN_CORRECTION;
        tt->struct_def.fields[0].enum_def.fields[25].name = tdrpStrDup("DBZ_ATTEN_CORRECTED");
        tt->struct_def.fields[0].enum_def.fields[25].val = DBZ_ATTEN_CORRECTED;
        tt->struct_def.fields[0].enum_def.fields[26].name = tdrpStrDup("ZDR_ATTEN_CORRECTED");
        tt->struct_def.fields[0].enum_def.fields[26].val = ZDR_ATTEN_CORRECTED;
        tt->struct_def.fields[0].enum_def.fields[27].name = tdrpStrDup("DBZ_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[27].val = DBZ_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[28].name = tdrpStrDup("ZDR_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[28].val = ZDR_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[29].name = tdrpStrDup("RHOHV_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[29].val = RHOHV_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[30].name = tdrpStrDup("SNR_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[30].val = SNR_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[31].name = tdrpStrDup("ZDR_SDEV_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[31].val = ZDR_SDEV_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[32].name = tdrpStrDup("VALID_FLAG_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[32].val = VALID_FLAG_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[33].name = tdrpStrDup("PHIDP_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[33].val = PHIDP_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[34].name = tdrpStrDup("PHIDP_MEAN_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[34].val = PHIDP_MEAN_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[35].name = tdrpStrDup("PHIDP_MEAN_UNFOLD_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[35].val = PHIDP_MEAN_UNFOLD_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[36].name = tdrpStrDup("PHIDP_SDEV_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[36].val = PHIDP_SDEV_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[37].name = tdrpStrDup("PHIDP_JITTER_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[37].val = PHIDP_JITTER_FOR_KDP;
        tt->struct_def.fields[0].enum_def.fields[38].name = tdrpStrDup("PHIDP_UNFOLD_FOR_KDP");
        tt->struct_def.fields[0].enum_def.fields[38].val = PHIDP_UNFOLD_FOR_KDP;
