...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.fields[62].name = tdrpStrDup("PHASE_CHANGE_RLAN");
        tt->struct_def.fields[0].enum_def.fields[62].val = PHASE_CHANGE_RLAN;
        tt->struct_def.fields[0].enum_def.fields[63].name = tdrpStrDup("ZDRM_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[63].val = ZDRM_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[64].name = tdrpStrDup("ZDRM_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[64].val = ZDRM_IN_BRAGG;
        tt->struct_def.fields[0].enum_def.fields[65].name = tdrpStrDup("ZDR_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[65].val = ZDR_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[66].name = tdrpStrDup("ZDR_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[66].val = ZDR_IN_BRAGG;
        tt->struct_def.fields[0].enum_def.fields[67].name = tdrpStrDup("ZDR_FLAG_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[67].val = ZDR_FLAG_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[68].name = tdrpStrDup("ZDR_FLAG_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[68].val = ZDR_FLAG_IN_BRAGG;
