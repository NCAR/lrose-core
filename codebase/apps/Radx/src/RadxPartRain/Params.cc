...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.fields[68].name = tdrpStrDup("ZDRM_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[68].val = ZDRM_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[69].name = tdrpStrDup("ZDRM_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[69].val = ZDRM_IN_BRAGG;
        tt->struct_def.fields[0].enum_def.fields[70].name = tdrpStrDup("ZDR_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[70].val = ZDR_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[71].name = tdrpStrDup("ZDR_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[71].val = ZDR_IN_BRAGG;
        tt->struct_def.fields[0].enum_def.fields[72].name = tdrpStrDup("ZDR_FLAG_IN_ICE");
        tt->struct_def.fields[0].enum_def.fields[72].val = ZDR_FLAG_IN_ICE;
        tt->struct_def.fields[0].enum_def.fields[73].name = tdrpStrDup("ZDR_FLAG_IN_BRAGG");
        tt->struct_def.fields[0].enum_def.fields[73].val = ZDR_FLAG_IN_BRAGG;
