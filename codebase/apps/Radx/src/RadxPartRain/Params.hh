...
public:
  ...
  typedef enum {
    ...
    ZDP = 13,
    PRECIP_RATE_ZH = 14,
    PRECIP_RATE_ZH_SNOW = 15,
    PRECIP_RATE_Z_ZDR = 16,
    PRECIP_RATE_KDP = 17,
    PRECIP_RATE_KDP_ZDR = 18,
    PRECIP_RATE_HYBRID = 19,
    PRECIP_RATE_PID = 20,
    PRECIP_RATE_HIDRO = 21,
    PRECIP_RATE_BRINGI = 22,
    DBZ_ATTEN_CORRECTION = 23,
    ZDR_ATTEN_CORRECTION = 24,
    DBZ_ATTEN_CORRECTED = 25,
    ZDR_ATTEN_CORRECTED = 26,
    DBZ_FOR_KDP = 27,
    ZDR_FOR_KDP = 28,
    RHOHV_FOR_KDP = 29,
    SNR_FOR_KDP = 30,
    ZDR_SDEV_FOR_KDP = 31,
    VALID_FLAG_FOR_KDP = 32,
    PHIDP_FOR_KDP = 33,
    PHIDP_MEAN_FOR_KDP = 34,
    PHIDP_MEAN_UNFOLD_FOR_KDP = 35,
    PHIDP_SDEV_FOR_KDP = 36,
    PHIDP_JITTER_FOR_KDP = 37,
    PHIDP_UNFOLD_FOR_KDP = 38,
