...
#include <cstring>
...

  {
    ...
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = ENUM_TYPE;
    tt->param_name = tdrpStrDup("mdv");
    tt->descr = tdrpStrDup("MDV option");
    tt->help = tdrpStrDup("If set, MDV output will also be produced.");
    tt->val_offset = (char *) &mdv - &_start_;
    tt->enum_def.name = tdrpStrDup("mdv_t");
    tt->enum_def.nfields = 2;
    tt->enum_def.fields = (enum_field_t *)
        tdrpMalloc(tt->enum_def.nfields * sizeof(enum_field_t));
      tt->enum_def.fields[0].name = tdrpStrDup("MDV_OFF");
      tt->enum_def.fields[0].val = MDV_OFF;
      tt->enum_def.fields[1].name = tdrpStrDup("MDV_ON");
      tt->enum_def.fields[1].val = MDV_ON;
    tt->single_val.e = MDV_OFF;
    tt++;
    ...
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("output_file");
    tt->descr = tdrpStrDup("Output path and filename.");
    tt->help = tdrpStrDup("The MM5 data is output to output_file in GRIB format.");
    tt->val_offset = (char *) &output_file - &_start_;
    tt->single_val.s = tdrpStrDup("./output.grib");
    tt++;
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.nfields = 112;
        ...
        tt->struct_def.fields[0].enum_def.fields[13].name = tdrpStrDup("TC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[13].val = TC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[14].name = tdrpStrDup("WSPD_FIELD");
        tt->struct_def.fields[0].enum_def.fields[14].val = WSPD_FIELD;
        tt->struct_def.fields[0].enum_def.fields[15].name = tdrpStrDup("WDIR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[15].val = WDIR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[16].name = tdrpStrDup("Z_FIELD");
        tt->struct_def.fields[0].enum_def.fields[16].val = Z_FIELD;
        tt->struct_def.fields[0].enum_def.fields[17].name = tdrpStrDup("DIVERGENCE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[17].val = DIVERGENCE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[18].name = tdrpStrDup("PRESSURE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[18].val = PRESSURE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[19].name = tdrpStrDup("RH_FIELD");
        tt->struct_def.fields[0].enum_def.fields[19].val = RH_FIELD;
        tt->struct_def.fields[0].enum_def.fields[20].name = tdrpStrDup("DEWPT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[20].val = DEWPT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[21].name = tdrpStrDup("TURB_FIELD");
        tt->struct_def.fields[0].enum_def.fields[21].val = TURB_FIELD;
        tt->struct_def.fields[0].enum_def.fields[22].name = tdrpStrDup("ICING_FIELD");
        tt->struct_def.fields[0].enum_def.fields[22].val = ICING_FIELD;
        tt->struct_def.fields[0].enum_def.fields[23].name = tdrpStrDup("BROWN1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[23].val = BROWN1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[24].name = tdrpStrDup("BROWN2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[24].val = BROWN2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[25].name = tdrpStrDup("CCAT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[25].val = CCAT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[26].name = tdrpStrDup("COLSON_PANOFSKY_FIELD");
        tt->struct_def.fields[0].enum_def.fields[26].val = COLSON_PANOFSKY_FIELD;
        tt->struct_def.fields[0].enum_def.fields[27].name = tdrpStrDup("DEF_SQR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[27].val = DEF_SQR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[28].name = tdrpStrDup("ELLROD1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[28].val = ELLROD1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[29].name = tdrpStrDup("ELLROD2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[29].val = ELLROD2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[30].name = tdrpStrDup("DUTTON_FIELD");
        tt->struct_def.fields[0].enum_def.fields[30].val = DUTTON_FIELD;
        tt->struct_def.fields[0].enum_def.fields[31].name = tdrpStrDup("ENDLICH_FIELD");
        tt->struct_def.fields[0].enum_def.fields[31].val = ENDLICH_FIELD;
        tt->struct_def.fields[0].enum_def.fields[32].name = tdrpStrDup("HSHEAR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[32].val = HSHEAR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[33].name = tdrpStrDup("LAZ_FIELD");
        tt->struct_def.fields[0].enum_def.fields[33].val = LAZ_FIELD;
        tt->struct_def.fields[0].enum_def.fields[34].name = tdrpStrDup("PVORT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[34].val = PVORT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[35].name = tdrpStrDup("PVORT_GRADIENT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[35].val = PVORT_GRADIENT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[36].name = tdrpStrDup("NGM1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[36].val = NGM1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[37].name = tdrpStrDup("NGM2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[37].val = NGM2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[38].name = tdrpStrDup("RICHARDSON_FIELD");
        tt->struct_def.fields[0].enum_def.fields[38].val = RICHARDSON_FIELD;
        tt->struct_def.fields[0].enum_def.fields[39].name = tdrpStrDup("RIT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[39].val = RIT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[40].name = tdrpStrDup("SAT_RI_FIELD");
        tt->struct_def.fields[0].enum_def.fields[40].val = SAT_RI_FIELD;
        tt->struct_def.fields[0].enum_def.fields[41].name = tdrpStrDup("STABILITY_FIELD");
        tt->struct_def.fields[0].enum_def.fields[41].val = STABILITY_FIELD;
        tt->struct_def.fields[0].enum_def.fields[42].name = tdrpStrDup("VORT_SQR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[42].val = VORT_SQR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[43].name = tdrpStrDup("VWSHEAR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[43].val = VWSHEAR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[44].name = tdrpStrDup("TKE_KH3_FIELD");
        tt->struct_def.fields[0].enum_def.fields[44].val = TKE_KH3_FIELD;
        tt->struct_def.fields[0].enum_def.fields[45].name = tdrpStrDup("TKE_KH4_FIELD");
        tt->struct_def.fields[0].enum_def.fields[45].val = TKE_KH4_FIELD;
        tt->struct_def.fields[0].enum_def.fields[46].name = tdrpStrDup("TKE_KH5_FIELD");
        tt->struct_def.fields[0].enum_def.fields[46].val = TKE_KH5_FIELD;
        tt->struct_def.fields[0].enum_def.fields[47].name = tdrpStrDup("START_2D_FIELDS");
        tt->struct_def.fields[0].enum_def.fields[47].val = START_2D_FIELDS;
        tt->struct_def.fields[0].enum_def.fields[48].name = tdrpStrDup("GROUND_T_FIELD");
        tt->struct_def.fields[0].enum_def.fields[48].val = GROUND_T_FIELD;
        tt->struct_def.fields[0].enum_def.fields[49].name = tdrpStrDup("RAIN_CON_FIELD");
        tt->struct_def.fields[0].enum_def.fields[49].val = RAIN_CON_FIELD;
        tt->struct_def.fields[0].enum_def.fields[50].name = tdrpStrDup("RAIN_NON_FIELD");
        tt->struct_def.fields[0].enum_def.fields[50].val = RAIN_NON_FIELD;
        tt->struct_def.fields[0].enum_def.fields[51].name = tdrpStrDup("TERRAIN_FIELD");
        tt->struct_def.fields[0].enum_def.fields[51].val = TERRAIN_FIELD;
        tt->struct_def.fields[0].enum_def.fields[52].name = tdrpStrDup("CORIOLIS_FIELD");
        tt->struct_def.fields[0].enum_def.fields[52].val = CORIOLIS_FIELD;
        tt->struct_def.fields[0].enum_def.fields[53].name = tdrpStrDup("RES_TEMP_FIELD");
        tt->struct_def.fields[0].enum_def.fields[53].val = RES_TEMP_FIELD;
        tt->struct_def.fields[0].enum_def.fields[54].name = tdrpStrDup("LAND_USE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[54].val = LAND_USE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[55].name = tdrpStrDup("SNOWCOVR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[55].val = SNOWCOVR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[56].name = tdrpStrDup("TSEASFC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[56].val = TSEASFC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[57].name = tdrpStrDup("PBL_HGT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[57].val = PBL_HGT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[58].name = tdrpStrDup("REGIME_FIELD");
        tt->struct_def.fields[0].enum_def.fields[58].val = REGIME_FIELD;
        tt->struct_def.fields[0].enum_def.fields[59].name = tdrpStrDup("SHFLUX_FIELD");
        tt->struct_def.fields[0].enum_def.fields[59].val = SHFLUX_FIELD;
        tt->struct_def.fields[0].enum_def.fields[60].name = tdrpStrDup("LHFLUX_FIELD");
        tt->struct_def.fields[0].enum_def.fields[60].val = LHFLUX_FIELD;
        tt->struct_def.fields[0].enum_def.fields[61].name = tdrpStrDup("UST_FIELD");
        tt->struct_def.fields[0].enum_def.fields[61].val = UST_FIELD;
        tt->struct_def.fields[0].enum_def.fields[62].name = tdrpStrDup("SWDOWN_FIELD");
        tt->struct_def.fields[0].enum_def.fields[62].val = SWDOWN_FIELD;
        tt->struct_def.fields[0].enum_def.fields[63].name = tdrpStrDup("LWDOWN_FIELD");
        tt->struct_def.fields[0].enum_def.fields[63].val = LWDOWN_FIELD;
        tt->struct_def.fields[0].enum_def.fields[64].name = tdrpStrDup("SOIL_T_1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[64].val = SOIL_T_1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[65].name = tdrpStrDup("SOIL_T_2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[65].val = SOIL_T_2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[66].name = tdrpStrDup("SOIL_T_3_FIELD");
        tt->struct_def.fields[0].enum_def.fields[66].val = SOIL_T_3_FIELD;
        tt->struct_def.fields[0].enum_def.fields[67].name = tdrpStrDup("SOIL_T_4_FIELD");
        tt->struct_def.fields[0].enum_def.fields[67].val = SOIL_T_4_FIELD;
        tt->struct_def.fields[0].enum_def.fields[68].name = tdrpStrDup("SOIL_T_5_FIELD");
        tt->struct_def.fields[0].enum_def.fields[68].val = SOIL_T_5_FIELD;
        tt->struct_def.fields[0].enum_def.fields[69].name = tdrpStrDup("SOIL_T_6_FIELD");
        tt->struct_def.fields[0].enum_def.fields[69].val = SOIL_T_6_FIELD;
        ...
        tt->struct_def.fields[0].enum_def.fields[74].name = tdrpStrDup("SFCRNOFF_FIELD");
        tt->struct_def.fields[0].enum_def.fields[74].val = SFCRNOFF_FIELD;
        tt->struct_def.fields[0].enum_def.fields[75].name = tdrpStrDup("SWFRAC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[75].val = SWFRAC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[76].name = tdrpStrDup("SUNALT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[76].val = SUNALT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[77].name = tdrpStrDup("SUNAZM_FIELD");
        tt->struct_def.fields[0].enum_def.fields[77].val = SUNAZM_FIELD;
        tt->struct_def.fields[0].enum_def.fields[78].name = tdrpStrDup("MOONALT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[78].val = MOONALT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[79].name = tdrpStrDup("MOONAZM_FIELD");
        tt->struct_def.fields[0].enum_def.fields[79].val = MOONAZM_FIELD;
        tt->struct_def.fields[0].enum_def.fields[80].name = tdrpStrDup("SUNILL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[80].val = SUNILL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[81].name = tdrpStrDup("MOONILL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[81].val = MOONILL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[82].name = tdrpStrDup("TOTALILL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[82].val = TOTALILL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[83].name = tdrpStrDup("CLWI_FIELD");
        tt->struct_def.fields[0].enum_def.fields[83].val = CLWI_FIELD;
        tt->struct_def.fields[0].enum_def.fields[84].name = tdrpStrDup("RNWI_FIELD");
        tt->struct_def.fields[0].enum_def.fields[84].val = RNWI_FIELD;
        tt->struct_def.fields[0].enum_def.fields[85].name = tdrpStrDup("ICEI_FIELD");
        tt->struct_def.fields[0].enum_def.fields[85].val = ICEI_FIELD;
        tt->struct_def.fields[0].enum_def.fields[86].name = tdrpStrDup("SNOWI_FIELD");
        tt->struct_def.fields[0].enum_def.fields[86].val = SNOWI_FIELD;
        tt->struct_def.fields[0].enum_def.fields[87].name = tdrpStrDup("PWV_FIELD");
        tt->struct_def.fields[0].enum_def.fields[87].val = PWV_FIELD;
        tt->struct_def.fields[0].enum_def.fields[88].name = tdrpStrDup("SUN_BTW");
        tt->struct_def.fields[0].enum_def.fields[88].val = SUN_BTW;
        tt->struct_def.fields[0].enum_def.fields[89].name = tdrpStrDup("SUN_ETW");
        tt->struct_def.fields[0].enum_def.fields[89].val = SUN_ETW;
        tt->struct_def.fields[0].enum_def.fields[90].name = tdrpStrDup("SUN_ABTW");
        tt->struct_def.fields[0].enum_def.fields[90].val = SUN_ABTW;
        tt->struct_def.fields[0].enum_def.fields[91].name = tdrpStrDup("SUN_AETW");
        tt->struct_def.fields[0].enum_def.fields[91].val = SUN_AETW;
        tt->struct_def.fields[0].enum_def.fields[92].name = tdrpStrDup("SUN_RISE");
        tt->struct_def.fields[0].enum_def.fields[92].val = SUN_RISE;
        tt->struct_def.fields[0].enum_def.fields[93].name = tdrpStrDup("SUN_SET");
        tt->struct_def.fields[0].enum_def.fields[93].val = SUN_SET;
        tt->struct_def.fields[0].enum_def.fields[94].name = tdrpStrDup("SUN_ARIS");
        tt->struct_def.fields[0].enum_def.fields[94].val = SUN_ARIS;
        tt->struct_def.fields[0].enum_def.fields[95].name = tdrpStrDup("SUN_ASET");
        tt->struct_def.fields[0].enum_def.fields[95].val = SUN_ASET;
        tt->struct_def.fields[0].enum_def.fields[96].name = tdrpStrDup("MOON_RIS");
        tt->struct_def.fields[0].enum_def.fields[96].val = MOON_RIS;
        tt->struct_def.fields[0].enum_def.fields[97].name = tdrpStrDup("MOON_SET");
        tt->struct_def.fields[0].enum_def.fields[97].val = MOON_SET;
        tt->struct_def.fields[0].enum_def.fields[98].name = tdrpStrDup("MOON_ARI");
        tt->struct_def.fields[0].enum_def.fields[98].val = MOON_ARI;
        tt->struct_def.fields[0].enum_def.fields[99].name = tdrpStrDup("MOON_ASE");
        tt->struct_def.fields[0].enum_def.fields[99].val = MOON_ASE;
        tt->struct_def.fields[0].enum_def.fields[100].name = tdrpStrDup("SUN_ALT");
        tt->struct_def.fields[0].enum_def.fields[100].val = SUN_ALT;
        tt->struct_def.fields[0].enum_def.fields[101].name = tdrpStrDup("SUN_AZI");
        tt->struct_def.fields[0].enum_def.fields[101].val = SUN_AZI;
        tt->struct_def.fields[0].enum_def.fields[102].name = tdrpStrDup("MOON_ALT");
        tt->struct_def.fields[0].enum_def.fields[102].val = MOON_ALT;
        tt->struct_def.fields[0].enum_def.fields[103].name = tdrpStrDup("MOON_AZI");
        tt->struct_def.fields[0].enum_def.fields[103].val = MOON_AZI;
        tt->struct_def.fields[0].enum_def.fields[104].name = tdrpStrDup("MOON_FRC");
        tt->struct_def.fields[0].enum_def.fields[104].val = MOON_FRC;
        tt->struct_def.fields[0].enum_def.fields[105].name = tdrpStrDup("NLAT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[105].val = NLAT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[106].name = tdrpStrDup("ELON_FIELD");
        tt->struct_def.fields[0].enum_def.fields[106].val = ELON_FIELD;
        tt->struct_def.fields[0].enum_def.fields[107].name = tdrpStrDup("FZLEVEL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[107].val = FZLEVEL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[108].name = tdrpStrDup("RAIN_TOTAL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[108].val = RAIN_TOTAL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[109].name = tdrpStrDup("RH2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[109].val = RH2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[110].name = tdrpStrDup("DEWPT2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[110].val = DEWPT2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[111].name = tdrpStrDup("MSLP2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[111].val = MSLP2_FIELD;
    ...
    tt->struct_vals = (tdrpVal_t *)
      ...
      tt->struct_vals[2].i = 33;
      tt->struct_vals[3].i = 2;
      tt->struct_vals[4].e = V_FIELD;
      tt->struct_vals[5].e = OUT_INT8;
      tt->struct_vals[6].i = 34;
      tt->struct_vals[7].i = 2;
      tt->struct_vals[8].e = WSPD_FIELD;
      tt->struct_vals[9].e = OUT_INT8;
      tt->struct_vals[10].i = 32;
      tt->struct_vals[11].i = 2;
      tt->struct_vals[12].e = TC_FIELD;
      tt->struct_vals[13].e = OUT_INT16;
      tt->struct_vals[14].i = 11;
      tt->struct_vals[15].i = 2;
      tt->struct_vals[16].e = RH_FIELD;
      tt->struct_vals[17].e = OUT_INT8;
      tt->struct_vals[18].i = 52;
      tt->struct_vals[19].i = 2;
      tt->struct_vals[20].e = CLW_FIELD;
      tt->struct_vals[21].e = OUT_INT8;
      tt->struct_vals[22].i = 153;
      tt->struct_vals[23].i = 2;
    tt++;
    ...
    tt->single_val.e = _MDV_COMPRESSION_RLE;
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("This MDV file was created by MM5toGrib.");
    tt++;
