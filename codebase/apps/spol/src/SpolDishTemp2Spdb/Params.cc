...
//
// Code for program SpolDishTemp2Spdb
//
...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("SpolDishTemp2Spdb reads dish temp records from ASCII files, converts them to station_report_t format and writes them to an SPDB data base.");
    ...
    tt->single_val.s = tdrpStrDup("/tmp/raw/spol_temp");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("TempSensor");
    tt++;
    ...
    tt->descr = tdrpStrDup("Output URL for temperature as station data.");
    tt->help = tdrpStrDup("Output data will be written to this URL.");
    tt->val_offset = (char *) &output_url - &_start_;
    tt->single_val.s = tdrpStrDup("spdbp:://localhost::spdb/spol_temp");
    tt++;
    ...
    tt->descr = tdrpStrDup("Expire time in seconds for each measurement");
    tt->help = tdrpStrDup("");
