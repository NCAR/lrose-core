...
//
// Code for program ShapeGridPt2Mdv
//
...
#include <cstring>
...

  {
    ...
    tt->descr = tdrpStrDup("Input path");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &input_path - &_start_;
    tt->single_val.s = tdrpStrDup("./grid.txt");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("./grid.mdv");
    tt++;
    ...
    tt->struct_vals = (tdrpVal_t *)
      ...
      tt->struct_vals[1].d = -12.2417;
      tt->struct_vals[2].d = 10.1417;
      tt->struct_vals[3].d = 0.00833333;
      tt->struct_vals[4].d = 0.00833333;
      tt->struct_vals[5].l = 1979;
      tt->struct_vals[6].l = 1783;
    ...
    tt->descr = tdrpStrDup("Output field units");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &output_field_units - &_start_;
    tt->single_val.s = tdrpStrDup("m");
    tt++;
    
    // Parameter 'conversion_table'
    // ctype is '_convert_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRUCT_TYPE;
    tt->param_name = tdrpStrDup("conversion_table");
    tt->descr = tdrpStrDup("Table of value conversions");
    tt->help = tdrpStrDup("If any of the given input values are found in the input file, they are changed to the given output value before being written to the output MDV file. This was added for the terrain files that were using the value 55537 to indicate ocean.");
    tt->array_offset = (char *) &_conversion_table - &_start_;
    tt->array_n_offset = (char *) &conversion_table_n - &_start_;
    tt->is_array = TRUE;
    tt->array_len_fixed = FALSE;
    tt->array_elem_size = sizeof(convert_t);
    tt->array_n = 0;
    tt->struct_def.name = tdrpStrDup("convert_t");
    tt->struct_def.nfields = 2;
    tt->struct_def.fields = (struct_field_t *)
        tdrpMalloc(tt->struct_def.nfields * sizeof(struct_field_t));
      tt->struct_def.fields[0].ftype = tdrpStrDup("double");
      tt->struct_def.fields[0].fname = tdrpStrDup("input_value");
      tt->struct_def.fields[0].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[0].rel_offset = 
        (char *) &_conversion_table->input_value - (char *) _conversion_table;
      tt->struct_def.fields[1].ftype = tdrpStrDup("double");
      tt->struct_def.fields[1].fname = tdrpStrDup("output_value");
      tt->struct_def.fields[1].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &_conversion_table->output_value - (char *) _conversion_table;
    tt->n_struct_vals = 0;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
    tt++;
