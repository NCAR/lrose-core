	...
	Event		*event;
{
	...
	for (i = 0; i < 1; i++) {
		...
		xv_set(Data_pu_data_pu->data_pu, FRAME_CMD_PUSHPIN_IN, TRUE, NULL);
		xv_set(Data_pu_data_pu->data_pu, XV_SHOW, TRUE, NULL);
	...
	Event		*event;
{
	...
	for (i = 0; i < 1; i++) {
		...
		xv_set(Zoom_pu_zoom_pu->zoom_pu, FRAME_CMD_PUSHPIN_IN, TRUE, NULL);
		xv_set(Zoom_pu_zoom_pu->zoom_pu, XV_SHOW, TRUE, NULL);
	...
	Event		*event;
{
	...
	for (i = 0; i < 1; i++) {
		...
		xv_set(Movie_pu_movie_pu->movie_pu, FRAME_CMD_PUSHPIN_IN, TRUE, NULL);
		xv_set(Movie_pu_movie_pu->movie_pu, XV_SHOW, TRUE, NULL);
	...
	Event		*event;
{
	...
	for (i = 0; i < 1; i++) {
		...
		xv_set(Extras_pu_extras_pu->extras_pu, XV_SHOW, TRUE, NULL);
	...
	Event		*event;
{
	...
	for (i = 0; i < 1; i++) {
		...
		xv_set(V_win_v_win_pu->v_win_pu, XV_SHOW, TRUE, NULL);
	...
	Event		*event;
{
	...
	for (i = 0; i < 1; i++) {
		...
		xv_set(Fields_pu_fields_pu->fields_pu, XV_SHOW, TRUE, NULL);
	...
	Event		*event;
{
	...
	fprintf(stderr, "cidd_gui: set_vectors_proc: value: %u\n", value);
