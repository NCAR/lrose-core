...
Moments::Moments(int n_samples /* = 128 */)
...
/////////////////////////////////////////////////////////////
// compute moments using SZ 16/128 algorithm and pulse-pair
// for RV dealiasing
  ...
  
{
  ...
  // check for 128 samples

  if (_nSamples != 128) {
    cerr << "ERROR - Moments::computeBySzPp" << endl;
    cerr << "  Can only be run with _nSamples = 128" << endl;
  ...
  if (_debugPrint) {
    cerr << "  SZ-16-128 PP estimates for strong trip:" << endl;
    cerr << "    method        : PP" << endl;
...
/////////////////////////////////////////////////////////////
// compute moments using SZ 16/128 algorithm and fft
// for RV dealiasing
  ...
  
{
  ...
  if (_debugPrint) {
    cerr << "  SZ-16-128 FFT estimates for strong trip:" << endl;
