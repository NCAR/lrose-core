...
//
// Code for program NidsRaster2Mdv
//
...
#include <cstring>
...

  {
    ...
    tt->help = tdrpStrDup("In realtime mode, NidsRaster2Mdv waits for a new input file. In archive mode, it moves through the files between the times set by the user.");
    ...
    tt->help = tdrpStrDup("The program starts a thread for each input directory. Incoming data is processed and written to the individual radar subdirectory output directory.");
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[2].fname = tdrpStrDup("is_dbz");
      tt->struct_def.fields[2].ptype = BOOL_TYPE;
      tt->struct_def.fields[2].rel_offset = 
        (char *) &_realtime_data_sets->is_dbz - (char *) _realtime_data_sets;
    tt->n_struct_vals = 3;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].s = tdrpStrDup(".");
      tt->struct_vals[1].s = tdrpStrDup("no-name");
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[2].ptype = BOOL_TYPE;
      tt->struct_def.fields[2].rel_offset = 
        (char *) &archive_data_set.is_dbz - (char *) &archive_data_set;
    tt->n_struct_vals = 3;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].s = tdrpStrDup(".");
    ...
    tt->help = tdrpStrDup("Some upstream processes, such as WsiNidsIngest, will generate latest_data_info for files. Others, such as the LDM, do not. If this option is on, each thread triggers off the latest_data_info file. If the option is off, the thread watches the directory for new files.");
    ...
    tt->help = tdrpStrDup("The program will create a subdirectory for each radar, using the radar name in lower case.");
    ...
    tt->descr = tdrpStrDup("Output grid x, y dimensions, minimum x, y and dx, dy.");
    ...
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].i = 116;
      tt->struct_vals[1].i = 116;
      tt->struct_vals[2].f = -230;
      tt->struct_vals[3].f = -230;
      tt->struct_vals[4].f = 4;
      tt->struct_vals[5].f = 4;
    tt++;
