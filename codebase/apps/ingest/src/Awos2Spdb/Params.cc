...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("STATION INFORMATION.");
    tt->comment_text = tdrpStrDup("");
    tt++;
    
    // Parameter 'station_info'
    // ctype is '_station_info_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRUCT_TYPE;
    tt->param_name = tdrpStrDup("station_info");
    tt->descr = tdrpStrDup("Station name and location information.");
    tt->help = tdrpStrDup("The station_id field is the 4-letter identifier that uniquely identifies each of the AWOS stations.");
    tt->val_offset = (char *) &station_info - &_start_;
    tt->struct_def.name = tdrpStrDup("station_info_t");
    tt->struct_def.nfields = 4;
    tt->struct_def.fields = (struct_field_t *)
        tdrpMalloc(tt->struct_def.nfields * sizeof(struct_field_t));
      tt->struct_def.fields[0].ftype = tdrpStrDup("string");
      tt->struct_def.fields[0].fname = tdrpStrDup("station_id");
      tt->struct_def.fields[0].ptype = STRING_TYPE;
      tt->struct_def.fields[0].rel_offset = 
        (char *) &station_info.station_id - (char *) &station_info;
      tt->struct_def.fields[1].ftype = tdrpStrDup("double");
      tt->struct_def.fields[1].fname = tdrpStrDup("latitude");
      tt->struct_def.fields[1].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &station_info.latitude - (char *) &station_info;
      tt->struct_def.fields[2].ftype = tdrpStrDup("double");
      tt->struct_def.fields[2].fname = tdrpStrDup("longitude");
      tt->struct_def.fields[2].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[2].rel_offset = 
        (char *) &station_info.longitude - (char *) &station_info;
      tt->struct_def.fields[3].ftype = tdrpStrDup("double");
      tt->struct_def.fields[3].fname = tdrpStrDup("altitude");
      tt->struct_def.fields[3].ptype = DOUBLE_TYPE;
      tt->struct_def.fields[3].rel_offset = 
        (char *) &station_info.altitude - (char *) &station_info;
    tt->n_struct_vals = 4;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].s = tdrpStrDup("KULS");
      tt->struct_vals[1].d = 37.604;
      tt->struct_vals[2].d = -101.373;
      tt->struct_vals[3].d = 934.8;
    tt++;
