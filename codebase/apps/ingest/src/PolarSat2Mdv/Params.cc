...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("Param file for Mdv2netCDF");
    ...
    // Parameter 'sparse_lat_fieldname'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("sparse_lat_fieldname");
    tt->descr = tdrpStrDup("Sparse geolocation latitude information including ground track and cross track end points");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &sparse_lat_fieldname - &_start_;
    tt->single_val.s = tdrpStrDup("Latitude@VIIRS-IMG-GTM-EDR-GEO");
    tt++;
    
    // Parameter 'sparse_lon_fieldname'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("sparse_lon_fieldname");
    tt->descr = tdrpStrDup("Sparse geolocation latitude information including ground track and cross track end points");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &sparse_lon_fieldname - &_start_;
    tt->single_val.s = tdrpStrDup("Longitude@VIIRS-IMG-GTM-EDR-GEO");
    tt++;
    
    // Parameter 'sat_data_fieldname'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("sat_data_fieldname");
    tt->descr = tdrpStrDup("Satellite data fieldname");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &sat_data_fieldname - &_start_;
    tt->single_val.s = tdrpStrDup("Reflectance@VIIRS-I1-IMG-EDR");
    tt++;
    
    // Parameter 'sat_data_short_name'
    // ctype is 'char*'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("sat_data_short_name");
    tt->descr = tdrpStrDup("Satellite data fieldname");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &sat_data_short_name - &_start_;
    tt->single_val.s = tdrpStrDup("Reflectance");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("noUnits");
    tt++;
    
    // Parameter 'min_sat_missing_or_bad'
    // ctype is 'int'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = INT_TYPE;
    tt->param_name = tdrpStrDup("min_sat_missing_or_bad");
    tt->descr = tdrpStrDup("Min missing or bad data");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &min_sat_missing_or_bad - &_start_;
    tt->single_val.i = 65528;
    tt++;
    
    // Parameter 'along_track_dim'
    // ctype is 'int'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = INT_TYPE;
    tt->param_name = tdrpStrDup("along_track_dim");
    tt->descr = tdrpStrDup("Along track dimension");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &along_track_dim - &_start_;
    tt->single_val.i = 1541;
    tt++;
    
    // Parameter 'cross_track_dim'
    // ctype is 'int'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = INT_TYPE;
    tt->param_name = tdrpStrDup("cross_track_dim");
    tt->descr = tdrpStrDup("Cross track dimension");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &cross_track_dim - &_start_;
    tt->single_val.i = 8241;
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("/tmp/netCDF");
    tt++;
    ...
    tt->struct_vals = (tdrpVal_t *)
      ...
      tt->struct_vals[1].d = -177.498;
      tt->struct_vals[2].d = 59.2721;
      tt->struct_vals[3].i = 8241;
      tt->struct_vals[4].i = 1541;
      tt->struct_vals[5].d = 0.0496;
    ...
    tt->single_val.s = tdrpStrDup("mdvp:://localhost::$(PROJECT)/mdv/polarSat");
    tt++;
    
    // Parameter 'collect_granular_data'
    // ctype is 'tdrp_bool_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = BOOL_TYPE;
    tt->param_name = tdrpStrDup("collect_granular_data");
    tt->descr = tdrpStrDup("Option to check successive files for input in the output domain and add to one Mdv file");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &collect_granular_data - &_start_;
    tt->single_val.b = pFALSE;
    tt++;
    ...
    tt->descr = tdrpStrDup("Maximum time to wait for a new file to append to other files. After this time, stored data will be written to disk. ");
    tt->help = tdrpStrDup("Used if collect_granular_data == true");
    tt->val_offset = (char *) &max_time_between_files - &_start_;
    tt->single_val.i = 180;
    tt++;
    
    // Parameter 'max_data_time_span_per_file'
    // ctype is 'int'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = INT_TYPE;
    tt->param_name = tdrpStrDup("max_data_time_span_per_file");
    tt->descr = tdrpStrDup("Maximum time time span for data in mdv file. If difference between begin and end times exceeds this value then, stored data will be written to disk and another Mdv file will be started for new data. ");
    tt->help = tdrpStrDup("Used if collect_granular_data == true");
    tt->val_offset = (char *) &max_data_time_span_per_file - &_start_;
    tt->single_val.i = 900;
    tt++;
