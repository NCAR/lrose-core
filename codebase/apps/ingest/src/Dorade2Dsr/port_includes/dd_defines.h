/* 	$Id: dd_defines.h,v 1.1 2007/09/22 21:08:21 dixon Exp $	 */
...
# define BA2F(x) ((fl32)(x)*ANGSCALE)
# define BA2RAD(x) ((fl32)(x)*BIN_ANG_TO_RADIANS)
...
# define RPM_TO_DPS(x) ((fl32)(x)*6.)
# ifndef US10
# define US10(x) ((fl32)(x)*.1)
# endif
# define SQ(x) ((x)*(x))
...
typedef   si32 *INT_PTR;
typedef fl32 *FLOAT_PTR;
typedef  si32 *LONG_PTR;
