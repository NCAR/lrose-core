...

  {
    ...
    tt->struct_def.fields = (struct_field_t *)
      ...
      tt->struct_def.fields[0].rel_offset = 
        ...
        tt->struct_def.fields[0].enum_def.nfields = 104;
        ...
        tt->struct_def.fields[0].enum_def.fields[17].name = tdrpStrDup("U_EDGE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[17].val = U_EDGE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[18].name = tdrpStrDup("V_EDGE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[18].val = V_EDGE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[19].name = tdrpStrDup("TK_FIELD");
        tt->struct_def.fields[0].enum_def.fields[19].val = TK_FIELD;
        tt->struct_def.fields[0].enum_def.fields[20].name = tdrpStrDup("TC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[20].val = TC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[21].name = tdrpStrDup("WSPD_FIELD");
        tt->struct_def.fields[0].enum_def.fields[21].val = WSPD_FIELD;
        tt->struct_def.fields[0].enum_def.fields[22].name = tdrpStrDup("WDIR_FIELD");
        tt->struct_def.fields[0].enum_def.fields[22].val = WDIR_FIELD;
        tt->struct_def.fields[0].enum_def.fields[23].name = tdrpStrDup("PRESSURE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[23].val = PRESSURE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[24].name = tdrpStrDup("RH_FIELD");
        tt->struct_def.fields[0].enum_def.fields[24].val = RH_FIELD;
        tt->struct_def.fields[0].enum_def.fields[25].name = tdrpStrDup("SPEC_H_FIELD");
        tt->struct_def.fields[0].enum_def.fields[25].val = SPEC_H_FIELD;
        tt->struct_def.fields[0].enum_def.fields[26].name = tdrpStrDup("DEWPT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[26].val = DEWPT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[27].name = tdrpStrDup("ICING_FIELD");
        tt->struct_def.fields[0].enum_def.fields[27].val = ICING_FIELD;
        tt->struct_def.fields[0].enum_def.fields[28].name = tdrpStrDup("CLW_G_FIELD");
        tt->struct_def.fields[0].enum_def.fields[28].val = CLW_G_FIELD;
        tt->struct_def.fields[0].enum_def.fields[29].name = tdrpStrDup("RNW_G_FIELD");
        tt->struct_def.fields[0].enum_def.fields[29].val = RNW_G_FIELD;
        tt->struct_def.fields[0].enum_def.fields[30].name = tdrpStrDup("THETA_FIELD");
        tt->struct_def.fields[0].enum_def.fields[30].val = THETA_FIELD;
        ...
        tt->struct_def.fields[0].enum_def.fields[32].name = tdrpStrDup("HGT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[32].val = HGT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[33].name = tdrpStrDup("Z_AGL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[33].val = Z_AGL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[34].name = tdrpStrDup("ITFADEF_FIELD");
        tt->struct_def.fields[0].enum_def.fields[34].val = ITFADEF_FIELD;
        tt->struct_def.fields[0].enum_def.fields[35].name = tdrpStrDup("GEO_POT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[35].val = GEO_POT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[36].name = tdrpStrDup("Q_G_FIELD");
        tt->struct_def.fields[0].enum_def.fields[36].val = Q_G_FIELD;
        tt->struct_def.fields[0].enum_def.fields[37].name = tdrpStrDup("CAPE_3D_FIELD");
        tt->struct_def.fields[0].enum_def.fields[37].val = CAPE_3D_FIELD;
        tt->struct_def.fields[0].enum_def.fields[38].name = tdrpStrDup("CIN_3D_FIELD");
        tt->struct_def.fields[0].enum_def.fields[38].val = CIN_3D_FIELD;
        tt->struct_def.fields[0].enum_def.fields[39].name = tdrpStrDup("LCL_3D_FIELD");
        tt->struct_def.fields[0].enum_def.fields[39].val = LCL_3D_FIELD;
        tt->struct_def.fields[0].enum_def.fields[40].name = tdrpStrDup("LFC_3D_FIELD");
        tt->struct_def.fields[0].enum_def.fields[40].val = LFC_3D_FIELD;
        tt->struct_def.fields[0].enum_def.fields[41].name = tdrpStrDup("EL_3D_FIELD");
        tt->struct_def.fields[0].enum_def.fields[41].val = EL_3D_FIELD;
        tt->struct_def.fields[0].enum_def.fields[42].name = tdrpStrDup("START_2D_FIELDS");
        tt->struct_def.fields[0].enum_def.fields[42].val = START_2D_FIELDS;
        tt->struct_def.fields[0].enum_def.fields[43].name = tdrpStrDup("SOIL_T_1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[43].val = SOIL_T_1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[44].name = tdrpStrDup("SOIL_T_2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[44].val = SOIL_T_2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[45].name = tdrpStrDup("SOIL_T_3_FIELD");
        tt->struct_def.fields[0].enum_def.fields[45].val = SOIL_T_3_FIELD;
        tt->struct_def.fields[0].enum_def.fields[46].name = tdrpStrDup("SOIL_T_4_FIELD");
        tt->struct_def.fields[0].enum_def.fields[46].val = SOIL_T_4_FIELD;
        tt->struct_def.fields[0].enum_def.fields[47].name = tdrpStrDup("SOIL_T_5_FIELD");
        tt->struct_def.fields[0].enum_def.fields[47].val = SOIL_T_5_FIELD;
        tt->struct_def.fields[0].enum_def.fields[48].name = tdrpStrDup("SOIL_M_1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[48].val = SOIL_M_1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[49].name = tdrpStrDup("SOIL_M_2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[49].val = SOIL_M_2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[50].name = tdrpStrDup("SOIL_M_3_FIELD");
        tt->struct_def.fields[0].enum_def.fields[50].val = SOIL_M_3_FIELD;
        tt->struct_def.fields[0].enum_def.fields[51].name = tdrpStrDup("SOIL_M_4_FIELD");
        tt->struct_def.fields[0].enum_def.fields[51].val = SOIL_M_4_FIELD;
        tt->struct_def.fields[0].enum_def.fields[52].name = tdrpStrDup("SOIL_M_5_FIELD");
        tt->struct_def.fields[0].enum_def.fields[52].val = SOIL_M_5_FIELD;
        tt->struct_def.fields[0].enum_def.fields[53].name = tdrpStrDup("SOIL_AM_1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[53].val = SOIL_AM_1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[54].name = tdrpStrDup("SOIL_AM_2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[54].val = SOIL_AM_2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[55].name = tdrpStrDup("SOIL_AM_3_FIELD");
        tt->struct_def.fields[0].enum_def.fields[55].val = SOIL_AM_3_FIELD;
        tt->struct_def.fields[0].enum_def.fields[56].name = tdrpStrDup("SOIL_AM_4_FIELD");
        tt->struct_def.fields[0].enum_def.fields[56].val = SOIL_AM_4_FIELD;
        tt->struct_def.fields[0].enum_def.fields[57].name = tdrpStrDup("SOIL_AM_5_FIELD");
        tt->struct_def.fields[0].enum_def.fields[57].val = SOIL_AM_5_FIELD;
        tt->struct_def.fields[0].enum_def.fields[58].name = tdrpStrDup("LAT_FIELD");
        tt->struct_def.fields[0].enum_def.fields[58].val = LAT_FIELD;
        tt->struct_def.fields[0].enum_def.fields[59].name = tdrpStrDup("LON_FIELD");
        tt->struct_def.fields[0].enum_def.fields[59].val = LON_FIELD;
        tt->struct_def.fields[0].enum_def.fields[60].name = tdrpStrDup("GROUND_T_FIELD");
        tt->struct_def.fields[0].enum_def.fields[60].val = GROUND_T_FIELD;
        tt->struct_def.fields[0].enum_def.fields[61].name = tdrpStrDup("RAINC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[61].val = RAINC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[62].name = tdrpStrDup("RAINNC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[62].val = RAINNC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[63].name = tdrpStrDup("TERRAIN_FIELD");
        tt->struct_def.fields[0].enum_def.fields[63].val = TERRAIN_FIELD;
        ...
        tt->struct_def.fields[0].enum_def.fields[68].name = tdrpStrDup("T2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[68].val = T2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[69].name = tdrpStrDup("Q2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[69].val = Q2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[70].name = tdrpStrDup("U10_FIELD");
        tt->struct_def.fields[0].enum_def.fields[70].val = U10_FIELD;
        tt->struct_def.fields[0].enum_def.fields[71].name = tdrpStrDup("V10_FIELD");
        tt->struct_def.fields[0].enum_def.fields[71].val = V10_FIELD;
        tt->struct_def.fields[0].enum_def.fields[72].name = tdrpStrDup("SNOWH_FIELD");
        tt->struct_def.fields[0].enum_def.fields[72].val = SNOWH_FIELD;
        tt->struct_def.fields[0].enum_def.fields[73].name = tdrpStrDup("SFC_PRES_FIELD");
        tt->struct_def.fields[0].enum_def.fields[73].val = SFC_PRES_FIELD;
        tt->struct_def.fields[0].enum_def.fields[74].name = tdrpStrDup("LAND_MASK_FIELD");
        tt->struct_def.fields[0].enum_def.fields[74].val = LAND_MASK_FIELD;
        tt->struct_def.fields[0].enum_def.fields[75].name = tdrpStrDup("TH2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[75].val = TH2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[76].name = tdrpStrDup("HFX_FIELD");
        tt->struct_def.fields[0].enum_def.fields[76].val = HFX_FIELD;
        tt->struct_def.fields[0].enum_def.fields[77].name = tdrpStrDup("LH_FIELD");
        tt->struct_def.fields[0].enum_def.fields[77].val = LH_FIELD;
        tt->struct_def.fields[0].enum_def.fields[78].name = tdrpStrDup("SNOW_WE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[78].val = SNOW_WE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[79].name = tdrpStrDup("SNOW_NC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[79].val = SNOW_NC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[80].name = tdrpStrDup("GRAUPEL_NC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[80].val = GRAUPEL_NC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[81].name = tdrpStrDup("SOIL_TYPE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[81].val = SOIL_TYPE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[82].name = tdrpStrDup("FZLEVEL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[82].val = FZLEVEL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[83].name = tdrpStrDup("RAIN_TOTAL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[83].val = RAIN_TOTAL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[84].name = tdrpStrDup("RH2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[84].val = RH2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[85].name = tdrpStrDup("T2C_FIELD");
        tt->struct_def.fields[0].enum_def.fields[85].val = T2C_FIELD;
        tt->struct_def.fields[0].enum_def.fields[86].name = tdrpStrDup("WSPD10_FIELD");
        tt->struct_def.fields[0].enum_def.fields[86].val = WSPD10_FIELD;
        tt->struct_def.fields[0].enum_def.fields[87].name = tdrpStrDup("WDIR10_FIELD");
        tt->struct_def.fields[0].enum_def.fields[87].val = WDIR10_FIELD;
        tt->struct_def.fields[0].enum_def.fields[88].name = tdrpStrDup("TWP_FIELD");
        tt->struct_def.fields[0].enum_def.fields[88].val = TWP_FIELD;
        tt->struct_def.fields[0].enum_def.fields[89].name = tdrpStrDup("RWP_FIELD");
        tt->struct_def.fields[0].enum_def.fields[89].val = RWP_FIELD;
        tt->struct_def.fields[0].enum_def.fields[90].name = tdrpStrDup("VIL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[90].val = VIL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[91].name = tdrpStrDup("DBZ_2D_FIELD");
        tt->struct_def.fields[0].enum_def.fields[91].val = DBZ_2D_FIELD;
        tt->struct_def.fields[0].enum_def.fields[92].name = tdrpStrDup("SPEC_H_2M_FIELD");
        tt->struct_def.fields[0].enum_def.fields[92].val = SPEC_H_2M_FIELD;
        tt->struct_def.fields[0].enum_def.fields[93].name = tdrpStrDup("CAPE_FIELD");
        tt->struct_def.fields[0].enum_def.fields[93].val = CAPE_FIELD;
        tt->struct_def.fields[0].enum_def.fields[94].name = tdrpStrDup("CIN_FIELD");
        tt->struct_def.fields[0].enum_def.fields[94].val = CIN_FIELD;
        tt->struct_def.fields[0].enum_def.fields[95].name = tdrpStrDup("LCL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[95].val = LCL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[96].name = tdrpStrDup("LFC_FIELD");
        tt->struct_def.fields[0].enum_def.fields[96].val = LFC_FIELD;
        tt->struct_def.fields[0].enum_def.fields[97].name = tdrpStrDup("EL_FIELD");
        tt->struct_def.fields[0].enum_def.fields[97].val = EL_FIELD;
        tt->struct_def.fields[0].enum_def.fields[98].name = tdrpStrDup("LANDUSEF_1_FIELD");
        tt->struct_def.fields[0].enum_def.fields[98].val = LANDUSEF_1_FIELD;
        tt->struct_def.fields[0].enum_def.fields[99].name = tdrpStrDup("LANDUSEF_2_FIELD");
        tt->struct_def.fields[0].enum_def.fields[99].val = LANDUSEF_2_FIELD;
        tt->struct_def.fields[0].enum_def.fields[100].name = tdrpStrDup("LANDUSEF_6_FIELD");
        tt->struct_def.fields[0].enum_def.fields[100].val = LANDUSEF_6_FIELD;
        tt->struct_def.fields[0].enum_def.fields[101].name = tdrpStrDup("LANDUSEF_15_FIELD");
        tt->struct_def.fields[0].enum_def.fields[101].val = LANDUSEF_15_FIELD;
        tt->struct_def.fields[0].enum_def.fields[102].name = tdrpStrDup("GREENFRAC_7_FIELD");
        tt->struct_def.fields[0].enum_def.fields[102].val = GREENFRAC_7_FIELD;
        tt->struct_def.fields[0].enum_def.fields[103].name = tdrpStrDup("TOTAL_FIELD_COUNT");
        tt->struct_def.fields[0].enum_def.fields[103].val = TOTAL_FIELD_COUNT;
    ...
    tt->struct_vals = (tdrpVal_t *)
      ...
      tt->struct_vals[57].e = ITFADEF_FIELD;
      tt->struct_vals[58].s = tdrpStrDup("ITFADEF");
      tt->struct_vals[59].s = tdrpStrDup("Turbulence severity - ITFA");
      tt->struct_vals[60].e = TK_FIELD;
      tt->struct_vals[61].s = tdrpStrDup("TK");
      tt->struct_vals[62].s = tdrpStrDup("Temperature");
      tt->struct_vals[63].e = TC_FIELD;
      tt->struct_vals[64].s = tdrpStrDup("Temp");
      tt->struct_vals[65].s = tdrpStrDup("Temperature");
      tt->struct_vals[66].e = WSPD_FIELD;
      tt->struct_vals[67].s = tdrpStrDup("Wspeed");
      tt->struct_vals[68].s = tdrpStrDup("Wind speed");
      tt->struct_vals[69].e = WDIR_FIELD;
      tt->struct_vals[70].s = tdrpStrDup("Wdir");
      tt->struct_vals[71].s = tdrpStrDup("Wind dirn");
      tt->struct_vals[72].e = PRESSURE_FIELD;
      tt->struct_vals[73].s = tdrpStrDup("pressure");
      tt->struct_vals[74].s = tdrpStrDup("Absolute pressure");
      tt->struct_vals[75].e = RH_FIELD;
      tt->struct_vals[76].s = tdrpStrDup("RH");
      tt->struct_vals[77].s = tdrpStrDup("Relative humidity");
      tt->struct_vals[78].e = SPEC_H_FIELD;
      tt->struct_vals[79].s = tdrpStrDup("SpecH");
      tt->struct_vals[80].s = tdrpStrDup("Specific humidity");
      tt->struct_vals[81].e = DEWPT_FIELD;
      tt->struct_vals[82].s = tdrpStrDup("DewPt");
      tt->struct_vals[83].s = tdrpStrDup("Dew point");
      tt->struct_vals[84].e = ICING_FIELD;
      tt->struct_vals[85].s = tdrpStrDup("Icing");
      tt->struct_vals[86].s = tdrpStrDup("Icing severity index");
      tt->struct_vals[87].e = CLW_G_FIELD;
      tt->struct_vals[88].s = tdrpStrDup("CLW_G");
      tt->struct_vals[89].s = tdrpStrDup("Cloud Liquid Mixing Ratio g/kg");
      tt->struct_vals[90].e = RNW_G_FIELD;
      tt->struct_vals[91].s = tdrpStrDup("RNW_G");
      tt->struct_vals[92].s = tdrpStrDup("Rain Liquid Mixing Ratio g/kg");
      tt->struct_vals[93].e = THETA_FIELD;
      tt->struct_vals[94].s = tdrpStrDup("THETA");
      tt->struct_vals[95].s = tdrpStrDup("Potential Temperature");
      tt->struct_vals[96].e = DBZ_3D_FIELD;
      tt->struct_vals[97].s = tdrpStrDup("dbz_3d");
      tt->struct_vals[98].s = tdrpStrDup("dBZ-3D Estimated");
      tt->struct_vals[99].e = HGT_FIELD;
      tt->struct_vals[100].s = tdrpStrDup("geo_hgt");
      tt->struct_vals[101].s = tdrpStrDup("Geopotential Height");
      tt->struct_vals[102].e = GEO_POT_FIELD;
      tt->struct_vals[103].s = tdrpStrDup("geo_pot");
      tt->struct_vals[104].s = tdrpStrDup("Geopotential");
      tt->struct_vals[105].e = Q_G_FIELD;
      tt->struct_vals[106].s = tdrpStrDup("Q_g");
      tt->struct_vals[107].s = tdrpStrDup("Mixing ratio g/kg");
      tt->struct_vals[108].e = CAPE_3D_FIELD;
      tt->struct_vals[109].s = tdrpStrDup("CAPE_3D");
      tt->struct_vals[110].s = tdrpStrDup("CAPE 3D");
      tt->struct_vals[111].e = CIN_3D_FIELD;
      tt->struct_vals[112].s = tdrpStrDup("CIN_3D");
      tt->struct_vals[113].s = tdrpStrDup("CIN 3D");
      tt->struct_vals[114].e = LCL_3D_FIELD;
      tt->struct_vals[115].s = tdrpStrDup("LCL_3D");
      tt->struct_vals[116].s = tdrpStrDup("LCL 3D");
      tt->struct_vals[117].e = LFC_3D_FIELD;
      tt->struct_vals[118].s = tdrpStrDup("LFC_3D");
      tt->struct_vals[119].s = tdrpStrDup("LFC 3D");
      tt->struct_vals[120].e = EL_3D_FIELD;
      tt->struct_vals[121].s = tdrpStrDup("EL_3D");
      tt->struct_vals[122].s = tdrpStrDup("EL 3D");
      tt->struct_vals[123].e = Z_AGL_FIELD;
      tt->struct_vals[124].s = tdrpStrDup("zz");
      tt->struct_vals[125].s = tdrpStrDup("Height above ground");
      tt->struct_vals[126].e = SOIL_T_1_FIELD;
      tt->struct_vals[127].s = tdrpStrDup("soil_t_1");
      tt->struct_vals[128].s = tdrpStrDup("Soil temperature in layer 1");
      tt->struct_vals[129].e = SOIL_T_2_FIELD;
      tt->struct_vals[130].s = tdrpStrDup("soil_t_2");
      tt->struct_vals[131].s = tdrpStrDup("Soil temperature in layer 2");
      tt->struct_vals[132].e = SOIL_T_3_FIELD;
      tt->struct_vals[133].s = tdrpStrDup("soil_t_3");
      tt->struct_vals[134].s = tdrpStrDup("Soil temperature in layer 3");
      tt->struct_vals[135].e = SOIL_T_4_FIELD;
      tt->struct_vals[136].s = tdrpStrDup("soil_t_4");
      tt->struct_vals[137].s = tdrpStrDup("Soil temperature in layer 4");
      tt->struct_vals[138].e = SOIL_T_5_FIELD;
      tt->struct_vals[139].s = tdrpStrDup("soil_t_5");
      tt->struct_vals[140].s = tdrpStrDup("Soil temperature in layer 5");
      tt->struct_vals[141].e = SOIL_M_1_FIELD;
      tt->struct_vals[142].s = tdrpStrDup("soil_m_1");
      tt->struct_vals[143].s = tdrpStrDup("Soil moisture in layer 1");
      tt->struct_vals[144].e = SOIL_M_2_FIELD;
      tt->struct_vals[145].s = tdrpStrDup("soil_m_2");
      tt->struct_vals[146].s = tdrpStrDup("Soil moisture in layer 2");
      tt->struct_vals[147].e = SOIL_M_3_FIELD;
      tt->struct_vals[148].s = tdrpStrDup("soil_m_3");
      tt->struct_vals[149].s = tdrpStrDup("Soil moisture in layer 3");
      tt->struct_vals[150].e = SOIL_M_4_FIELD;
      tt->struct_vals[151].s = tdrpStrDup("soil_m_4");
      tt->struct_vals[152].s = tdrpStrDup("Soil moisture in layer 4");
      tt->struct_vals[153].e = SOIL_M_5_FIELD;
      tt->struct_vals[154].s = tdrpStrDup("soil_m_5");
      tt->struct_vals[155].s = tdrpStrDup("Soil moisture in layer 5");
      tt->struct_vals[156].e = SOIL_AM_1_FIELD;
      tt->struct_vals[157].s = tdrpStrDup("soil_am_1");
      tt->struct_vals[158].s = tdrpStrDup("Available Soil moisture in layer 1");
      tt->struct_vals[159].e = SOIL_AM_2_FIELD;
      tt->struct_vals[160].s = tdrpStrDup("soil_am_2");
      tt->struct_vals[161].s = tdrpStrDup("Available Soil moisture in layer 2");
      tt->struct_vals[162].e = SOIL_AM_3_FIELD;
      tt->struct_vals[163].s = tdrpStrDup("soil_am_3");
      tt->struct_vals[164].s = tdrpStrDup("Available Soil moisture in layer 3");
      tt->struct_vals[165].e = SOIL_AM_4_FIELD;
      tt->struct_vals[166].s = tdrpStrDup("soil_am_4");
      tt->struct_vals[167].s = tdrpStrDup("Available Soil moisture in layer 4");
      tt->struct_vals[168].e = SOIL_AM_5_FIELD;
      tt->struct_vals[169].s = tdrpStrDup("soil_am_5");
      tt->struct_vals[170].s = tdrpStrDup("Available Soil moisture in layer 5");
      tt->struct_vals[171].e = LAT_FIELD;
      tt->struct_vals[172].s = tdrpStrDup("latitude");
      tt->struct_vals[173].s = tdrpStrDup("Latitude");
      tt->struct_vals[174].e = LON_FIELD;
      tt->struct_vals[175].s = tdrpStrDup("longitude");
      tt->struct_vals[176].s = tdrpStrDup("Longitude");
      tt->struct_vals[177].e = GROUND_T_FIELD;
      tt->struct_vals[178].s = tdrpStrDup("ground_t");
      tt->struct_vals[179].s = tdrpStrDup("Ground temperature");
      tt->struct_vals[180].e = RAINC_FIELD;
      tt->struct_vals[181].s = tdrpStrDup("rainc");
      tt->struct_vals[182].s = tdrpStrDup("Accumulated Total Cumulus Precipitation");
      tt->struct_vals[183].e = RAINNC_FIELD;
      tt->struct_vals[184].s = tdrpStrDup("rainnc");
      tt->struct_vals[185].s = tdrpStrDup("Accumulated Total Grid Scale Precipitation");
      tt->struct_vals[186].e = TERRAIN_FIELD;
      tt->struct_vals[187].s = tdrpStrDup("terrain");
      tt->struct_vals[188].s = tdrpStrDup("Terrain height");
      tt->struct_vals[189].e = LAND_USE_FIELD;
      tt->struct_vals[190].s = tdrpStrDup("land_use");
      tt->struct_vals[191].s = tdrpStrDup("Land use category");
      tt->struct_vals[192].e = SNOWCOVR_FIELD;
      tt->struct_vals[193].s = tdrpStrDup("snowcovr");
      tt->struct_vals[194].s = tdrpStrDup("Snow cover flags");
      tt->struct_vals[195].e = TSEASFC_FIELD;
      tt->struct_vals[196].s = tdrpStrDup("tseasfc");
      tt->struct_vals[197].s = tdrpStrDup("Sea surface temperature");
      tt->struct_vals[198].e = PBL_HGT_FIELD;
      tt->struct_vals[199].s = tdrpStrDup("pbl_hgt");
      tt->struct_vals[200].s = tdrpStrDup("Pbl height");
      tt->struct_vals[201].e = T2_FIELD;
      tt->struct_vals[202].s = tdrpStrDup("T2");
      tt->struct_vals[203].s = tdrpStrDup("2-meter Temperature");
      tt->struct_vals[204].e = Q2_FIELD;
      tt->struct_vals[205].s = tdrpStrDup("Q2");
      tt->struct_vals[206].s = tdrpStrDup("2-meter Mixing Ratio");
      tt->struct_vals[207].e = U10_FIELD;
      tt->struct_vals[208].s = tdrpStrDup("U10");
      tt->struct_vals[209].s = tdrpStrDup("10-meter U Component");
      tt->struct_vals[210].e = V10_FIELD;
      tt->struct_vals[211].s = tdrpStrDup("V10");
      tt->struct_vals[212].s = tdrpStrDup("10-meter V Component");
      tt->struct_vals[213].e = SNOWH_FIELD;
      tt->struct_vals[214].s = tdrpStrDup("snowh");
      tt->struct_vals[215].s = tdrpStrDup("Physical snow depth");
      tt->struct_vals[216].e = SFC_PRES_FIELD;
      tt->struct_vals[217].s = tdrpStrDup("surfP");
      tt->struct_vals[218].s = tdrpStrDup("Surface Pressure");
      tt->struct_vals[219].e = LAND_MASK_FIELD;
      tt->struct_vals[220].s = tdrpStrDup("land_mask");
      tt->struct_vals[221].s = tdrpStrDup("Land Mask (1-land 0-water)");
      tt->struct_vals[222].e = TH2_FIELD;
      tt->struct_vals[223].s = tdrpStrDup("TH2");
      tt->struct_vals[224].s = tdrpStrDup("POT TEMP at 2 M");
      tt->struct_vals[225].e = HFX_FIELD;
      tt->struct_vals[226].s = tdrpStrDup("HFX");
      tt->struct_vals[227].s = tdrpStrDup("UPWARD HEAT FLUX AT THE SURFACE");
      tt->struct_vals[228].e = LH_FIELD;
      tt->struct_vals[229].s = tdrpStrDup("LH");
      tt->struct_vals[230].s = tdrpStrDup("LATENT HEAT FLUX AT THE SURFACE");
      tt->struct_vals[231].e = SNOW_WE_FIELD;
      tt->struct_vals[232].s = tdrpStrDup("SNOW_WE");
      tt->struct_vals[233].s = tdrpStrDup("SNOW WATER EQUIVALENT");
      tt->struct_vals[234].e = SNOW_NC_FIELD;
      tt->struct_vals[235].s = tdrpStrDup("SNOW_NC");
      tt->struct_vals[236].s = tdrpStrDup("ACCUMULATED TOTAL GRID SCALE SNOW AND ICE");
      tt->struct_vals[237].e = GRAUPEL_NC_FIELD;
      tt->struct_vals[238].s = tdrpStrDup("GRAUPEL_NC");
      tt->struct_vals[239].s = tdrpStrDup("ACCUMULATED TOTAL GRID SCALE GRAUPEL");
      tt->struct_vals[240].e = SOIL_TYPE_FIELD;
      tt->struct_vals[241].s = tdrpStrDup("SOIL_TYPE");
      tt->struct_vals[242].s = tdrpStrDup("DOMINANT SOIL CATEGORY");
      tt->struct_vals[243].e = FZLEVEL_FIELD;
      tt->struct_vals[244].s = tdrpStrDup("FZLevel");
      tt->struct_vals[245].s = tdrpStrDup("freezing level");
      tt->struct_vals[246].e = RAIN_TOTAL_FIELD;
      tt->struct_vals[247].s = tdrpStrDup("rain_total");
      tt->struct_vals[248].s = tdrpStrDup("Rain accumulation - con + non");
      tt->struct_vals[249].e = T2C_FIELD;
      tt->struct_vals[250].s = tdrpStrDup("T2C");
      tt->struct_vals[251].s = tdrpStrDup("2-meter Temperature in C");
      tt->struct_vals[252].e = DBZ_2D_FIELD;
      tt->struct_vals[253].s = tdrpStrDup("dbz_2d");
      tt->struct_vals[254].s = tdrpStrDup("dBZ-2D Estimated");
      tt->struct_vals[255].e = RH2_FIELD;
      tt->struct_vals[256].s = tdrpStrDup("RH2");
      tt->struct_vals[257].s = tdrpStrDup("Relative humidity at 2 meters");
      tt->struct_vals[258].e = WSPD10_FIELD;
      tt->struct_vals[259].s = tdrpStrDup("Wspeed10");
      tt->struct_vals[260].s = tdrpStrDup("Wind speed at 10 meters");
      tt->struct_vals[261].e = WDIR10_FIELD;
      tt->struct_vals[262].s = tdrpStrDup("Wdir10");
      tt->struct_vals[263].s = tdrpStrDup("Wind direction at 10 meters");
      tt->struct_vals[264].e = LANDUSEF_1_FIELD;
      tt->struct_vals[265].s = tdrpStrDup("Landusef_1");
      tt->struct_vals[266].s = tdrpStrDup("Landuse (urban)");
      tt->struct_vals[267].e = LANDUSEF_2_FIELD;
      tt->struct_vals[268].s = tdrpStrDup("Landusef_2");
      tt->struct_vals[269].s = tdrpStrDup("Landuse (crops/woods)");
      tt->struct_vals[270].e = LANDUSEF_6_FIELD;
      tt->struct_vals[271].s = tdrpStrDup("Landusef_6");
      tt->struct_vals[272].s = tdrpStrDup("Landuse (dryland crops and pasture)");
      tt->struct_vals[273].e = LANDUSEF_15_FIELD;
      tt->struct_vals[274].s = tdrpStrDup("Landusef_15");
      tt->struct_vals[275].s = tdrpStrDup("Landuse (mixed forest)");
      tt->struct_vals[276].e = GREENFRAC_7_FIELD;
      tt->struct_vals[277].s = tdrpStrDup("Greenfrac_7");
      tt->struct_vals[278].s = tdrpStrDup("Green Fraction (July)");
      tt->struct_vals[279].e = TWP_FIELD;
      tt->struct_vals[280].s = tdrpStrDup("twp");
      tt->struct_vals[281].s = tdrpStrDup("Total Water Path");
      tt->struct_vals[282].e = VIL_FIELD;
      tt->struct_vals[283].s = tdrpStrDup("vil");
      tt->struct_vals[284].s = tdrpStrDup("digital vil");
      tt->struct_vals[285].e = RWP_FIELD;
      tt->struct_vals[286].s = tdrpStrDup("rwp");
      tt->struct_vals[287].s = tdrpStrDup("Rain Water Path");
      tt->struct_vals[288].e = SPEC_H_2M_FIELD;
      tt->struct_vals[289].s = tdrpStrDup("spec_h2m");
      tt->struct_vals[290].s = tdrpStrDup("Specific Humidity at 2 meters");
      tt->struct_vals[291].e = CAPE_FIELD;
      tt->struct_vals[292].s = tdrpStrDup("CAPE");
      tt->struct_vals[293].s = tdrpStrDup("CAPE");
      tt->struct_vals[294].e = CIN_FIELD;
      tt->struct_vals[295].s = tdrpStrDup("CIN");
      tt->struct_vals[296].s = tdrpStrDup("CIN");
      tt->struct_vals[297].e = LCL_FIELD;
      tt->struct_vals[298].s = tdrpStrDup("LCL");
      tt->struct_vals[299].s = tdrpStrDup("LCL");
      tt->struct_vals[300].e = LFC_FIELD;
      tt->struct_vals[301].s = tdrpStrDup("LFC");
      tt->struct_vals[302].s = tdrpStrDup("LFC");
      tt->struct_vals[303].e = EL_FIELD;
      tt->struct_vals[304].s = tdrpStrDup("EL");
      tt->struct_vals[305].s = tdrpStrDup("EL");
    tt++;
