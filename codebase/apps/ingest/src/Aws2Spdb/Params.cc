...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("Aws2Spdb reads AWS records from ASCII files and converts them to station_report_t format and writes them to an SPDB data base.");
    ...
    tt->single_val.s = tdrpStrDup("$(RAP_DATA_DIR)/$(PROJECT)/raw/AWS");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("spdbp:://localhost::$(PROJECT)/spdb/aws");
    tt++;
