...
//
// Code for program GtsSockIngest
//
...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("GtsSockIngest reads family of services data from a GTS socket and writes the data to files at regular intervals");
    ...
    tt->descr = tdrpStrDup("Number of port to listen on.");
    tt->help = tdrpStrDup("This GTS server will connect to this port.");
    ...
    tt->comment_hdr = tdrpStrDup("DATA FILE OUTPUT.");
    tt->comment_text = tdrpStrDup("");
    tt++;
    ...
    tt->single_val.e = EOM_CHECK_CTRLC;
    tt++;
