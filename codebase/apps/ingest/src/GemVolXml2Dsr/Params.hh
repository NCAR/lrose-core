...
public:
  ...
  int input_file_quiescence_secs;

  int input_file_time_offset_secs;
  ...
  polar_mode_t polarization_mode;

  double short_pulse_width_us;

  double long_pulse_width_us;
