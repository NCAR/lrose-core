...
//
// Code for program MultMsgFmq2Fmq
//
...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("MultMsgFmq2Fmq program");
    tt->comment_text = tdrpStrDup("MultMsgFmq2Fmq reads an FMQ into which multiple messages have been put by Fmq2MultMsgFmq, unpacks the messages and writes the individual messages to an output FMQ. See Fmq2MultMsgFmq for details on writing the multiple-message FMQ.");
    tt++;
