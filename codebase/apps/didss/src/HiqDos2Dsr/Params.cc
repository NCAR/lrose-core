...
#include <cstring>
...

  {
    ...
    tt->help = tdrpStrDup("If set to true, the volume number will be taken from the HiQ beam header. If set to false, the volume number will be determined based on the scan strategy and end-of-volume information given below.");
