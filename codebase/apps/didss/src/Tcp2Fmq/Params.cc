...
#include <cstring>
...

  {
    ...
    tt->descr = tdrpStrDup("Host name for input TCP data.");
    tt->help = tdrpStrDup("The program reads the UDP data from this host.");
    ...
    tt->descr = tdrpStrDup("Port number of input TCP data.");
    ...
    tt->descr = tdrpStrDup("URL for FMQ output.");
    tt->help = tdrpStrDup("The output data is written to the FMQ at this URL.");
    tt->val_offset = (char *) &output_fmq_url - &_start_;
    tt->single_val.s = tdrpStrDup("fmqp:://localhost::fmq/test");
    tt++;
    ...
    tt->help = tdrpStrDup("The FMQ wraps around when the slots have been filled.");
    ...
    tt->descr = tdrpStrDup("Size of message queue in bytes.");
    tt->help = tdrpStrDup("The FMQ wraps around when the buffer has been filled.");
    tt->val_offset = (char *) &output_fmq_size - &_start_;
    tt->single_val.i = 10000000;
    tt++;
    
    // Parameter 'output_fmq_compressed'
    // ctype is 'tdrp_bool_t'
    
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = BOOL_TYPE;
    tt->param_name = tdrpStrDup("output_fmq_compressed");
    tt->descr = tdrpStrDup("Option to compress data in FMQ.");
    tt->help = tdrpStrDup("");
    tt->val_offset = (char *) &output_fmq_compressed - &_start_;
