...
#include <cstring>
...

  {
    ...
    tt->descr = tdrpStrDup("Generation timestep");
    tt->help = tdrpStrDup("Approximate time step, seconds, for generating files.");
    ...
    memset(tt, 0, sizeof(TDRPtable));
    tt->ptype = STRING_TYPE;
    tt->param_name = tdrpStrDup("OutputDir");
    tt->descr = tdrpStrDup("Output directory");
    tt->help = tdrpStrDup("Directory to write pseudo-noaaport ltg output files to");
    tt->val_offset = (char *) &OutputDir - &_start_;
