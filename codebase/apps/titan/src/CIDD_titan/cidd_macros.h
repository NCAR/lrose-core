 ...
 *  Frank Hage NCAR/RAP 1991
 */
#ifndef CIDD_MACROS_H
#define CIDD_MACROS_H

#define CIDD_VERSION    "2.166  Mar 24, 2008"
#define CIDD_COPYRIGHT  "(c) 1991-2008,  University Corporation for Atmospheric Research - All Rights reserved"
#define APP_DATABASE    "http://www.rap.ucar.edu/CIDD/CIDD.master"   /* the default prarmeter database */
...
#define CLOSEST_TO_FRAME_CENTER 0
#define FIRST_BEFORE_END_OF_FRAME 1
#define FIRST_AFTER_START_OF_FRAME 2
