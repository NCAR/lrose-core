...
//
// Code for program AcPosnAscii2Spdb
//
...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("Program name: AcPosnAscii2Spdb");
    tt->comment_text = tdrpStrDup("AcPosnAscii2Spdb converts ascii ac_posn data into SPDB format. The usage is 'AcPosnAscii2Spdb -params params_file'.");
    tt++;
