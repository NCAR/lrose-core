...
//
// Code for program Tstorms2GenPoly
//
...
#include <cstring>
...

  {
    ...
    tt->comment_text = tdrpStrDup("This program is used to convert the storms in a Titan storms SPDB database into a GenPoly (generic polyline) SPDB database.");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("spdbp:://localhost::spdb/titan_storms");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("spdbp:://localhost::spdb/gen_poly_storms");
    tt++;
    ...
    tt->descr = tdrpStrDup("Number of seconds before the GenPoly object expires");
    tt->help = tdrpStrDup("");
    ...
    tt->descr = tdrpStrDup("Array of fields to include in the output database");
    tt->help = tdrpStrDup("Each specified Titan field is included as a database field using the given database field name.");
    ...
    tt->struct_def.fields = (struct_field_t *)
        tdrpMalloc(tt->struct_def.nfields * sizeof(struct_field_t));
      tt->struct_def.fields[0].ftype = tdrpStrDup("titan_fields_t");
      tt->struct_def.fields[0].fname = tdrpStrDup("titan_field");
      tt->struct_def.fields[0].ptype = ENUM_TYPE;
      tt->struct_def.fields[0].rel_offset = 
        (char *) &_output_fields->titan_field - (char *) _output_fields;
        tt->struct_def.fields[0].enum_def.name = tdrpStrDup("titan_fields_t");
        tt->struct_def.fields[0].enum_def.nfields = 10;
        tt->struct_def.fields[0].enum_def.fields = (enum_field_t *) tdrpMalloc
          (tt->struct_def.fields[0].enum_def.nfields * sizeof(enum_field_t));
        tt->struct_def.fields[0].enum_def.fields[0].name = tdrpStrDup("AREA");
        tt->struct_def.fields[0].enum_def.fields[0].val = AREA;
        tt->struct_def.fields[0].enum_def.fields[1].name = tdrpStrDup("SPEED");
        tt->struct_def.fields[0].enum_def.fields[1].val = SPEED;
        tt->struct_def.fields[0].enum_def.fields[2].name = tdrpStrDup("DIRECTION");
        tt->struct_def.fields[0].enum_def.fields[2].val = DIRECTION;
        tt->struct_def.fields[0].enum_def.fields[3].name = tdrpStrDup("U");
        tt->struct_def.fields[0].enum_def.fields[3].val = U;
        tt->struct_def.fields[0].enum_def.fields[4].name = tdrpStrDup("V");
        tt->struct_def.fields[0].enum_def.fields[4].val = V;
        tt->struct_def.fields[0].enum_def.fields[5].name = tdrpStrDup("ASPECT_RATIO");
        tt->struct_def.fields[0].enum_def.fields[5].val = ASPECT_RATIO;
        tt->struct_def.fields[0].enum_def.fields[6].name = tdrpStrDup("SIMPLE_TRACK_ID");
        tt->struct_def.fields[0].enum_def.fields[6].val = SIMPLE_TRACK_ID;
        tt->struct_def.fields[0].enum_def.fields[7].name = tdrpStrDup("COMPLEX_TRACK_ID");
        tt->struct_def.fields[0].enum_def.fields[7].val = COMPLEX_TRACK_ID;
        tt->struct_def.fields[0].enum_def.fields[8].name = tdrpStrDup("CENTROID_LAT");
        tt->struct_def.fields[0].enum_def.fields[8].val = CENTROID_LAT;
        tt->struct_def.fields[0].enum_def.fields[9].name = tdrpStrDup("CENTROID_LON");
        tt->struct_def.fields[0].enum_def.fields[9].val = CENTROID_LON;
      tt->struct_def.fields[1].ftype = tdrpStrDup("string");
      tt->struct_def.fields[1].fname = tdrpStrDup("gen_poly_field_name");
      tt->struct_def.fields[1].ptype = STRING_TYPE;
      tt->struct_def.fields[1].rel_offset = 
        (char *) &_output_fields->gen_poly_field_name - (char *) _output_fields;
    tt->n_struct_vals = 6;
    tt->struct_vals = (tdrpVal_t *)
        tdrpMalloc(tt->n_struct_vals * sizeof(tdrpVal_t));
      tt->struct_vals[0].e = AREA;
      tt->struct_vals[1].s = tdrpStrDup("area");
      tt->struct_vals[2].e = SPEED;
      tt->struct_vals[3].s = tdrpStrDup("speed");
      tt->struct_vals[4].e = DIRECTION;
      tt->struct_vals[5].s = tdrpStrDup("direction");
    tt++;
