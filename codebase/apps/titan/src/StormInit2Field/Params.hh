...
public:
  ...
  tdrp_bool_t applyAreaThresholds;

  thresh_t areaThresholds;

  tdrp_bool_t applyDurationThresholds;

  thresh_t durationThresholds;
  ...
  tdrp_bool_t boundaryProximityRequired;

  char* boundarySpdbUrl;

  long boundaryLookback;
