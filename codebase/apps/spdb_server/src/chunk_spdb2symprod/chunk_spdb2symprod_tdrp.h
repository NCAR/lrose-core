/*******************************************
 * chunk_spdb2symprod_tdrp.h
 *
 * TDRP header file for 'chunk_spdb2symprod' module.
 *
...
#ifndef _chunk_spdb2symprod_tdrp_h
#define _chunk_spdb2symprod_tdrp_h
...
typedef enum {
  ...
  DEBUG_ROUTINES = 3,
  DEBUG_ALL = 4
} chunk_spdb2symprod_debug_t;

/*
 * typedef for main struct - chunk_spdb2symprod_tdrp_struct
 */
...
typedef struct {
  ...
  chunk_spdb2symprod_debug_t debug;
...
} chunk_spdb2symprod_tdrp_struct;
...
extern int chunk_spdb2symprod_tdrp_load_from_args(int argc, char **argv,
...
extern int chunk_spdb2symprod_tdrp_load(char *param_file_path,
                      chunk_spdb2symprod_tdrp_struct *params,
                      char **override_list,
...
extern int chunk_spdb2symprod_tdrp_load_defaults(chunk_spdb2symprod_tdrp_struct *params,
                               int expand_env);
...
extern void chunk_spdb2symprod_tdrp_sync(void);
...
extern void chunk_spdb2symprod_tdrp_print(FILE *out, tdrp_print_mode_t mode);
...
extern void chunk_spdb2symprod_tdrp_free_all(void);
...
extern int chunk_spdb2symprod_tdrp_check_all_set(FILE *out);
...
extern int chunk_spdb2symprod_tdrp_check_is_set(char *param_name);
...
extern int chunk_spdb2symprod_tdrp_array_realloc(char *param_name,
                              int new_array_n);
...
extern int chunk_spdb2symprod_tdrp_array2D_realloc(char *param_name,
                                 int new_array_n1,
                                 int new_array_n2);
...
extern TDRPtable *chunk_spdb2symprod_tdrp_table(void);
...
extern TDRPtable *chunk_spdb2symprod_tdrp_init(chunk_spdb2symprod_tdrp_struct *params);
