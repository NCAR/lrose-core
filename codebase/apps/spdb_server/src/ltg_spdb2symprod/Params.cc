...
//
// Code for program ltg_spdb2symprod
//
...
#include <cstring>
...

  {
    ...
    tt->val_offset = (char *) &wait_msecs - &_start_;
    tt->single_val.l = 100;
    tt++;
    ...
    tt->val_offset = (char *) &database_dir - &_start_;
    ...
    tt->single_val.s = tdrpStrDup("Kavouras Lightning Data");
    tt++;
    ...
    tt->val_offset = (char *) &servmap_type - &_start_;
    ...
    tt->val_offset = (char *) &servmap_subtype - &_start_;
    tt->single_val.s = tdrpStrDup("Spdb");
    tt++;
    ...
    tt->val_offset = (char *) &servmap_instance - &_start_;
    ...
    tt->val_offset = (char *) &realtime_avail - &_start_;
