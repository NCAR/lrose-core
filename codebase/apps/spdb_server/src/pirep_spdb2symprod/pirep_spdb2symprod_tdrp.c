/*******************************************
 * pirep_spdb2symprod_tdrp.c
 *
 * TDRP C code file 'pirep_spdb2symprod' module.
 *
 * Code for program pirep_spdb2symprod
 *
...
static pirep_spdb2symprod_tdrp_struct *Params;
static char *Module = "pirep_spdb2symprod";

/*************************************************************
 * pirep_spdb2symprod_tdrp_load_from_args()
 *
 ...
 *
 *   pirep_spdb2symprod_tdrp_struct *params: loads up this struct
 * 
...
int pirep_spdb2symprod_tdrp_load_from_args(int argc, char **argv,
                         pirep_spdb2symprod_tdrp_struct *params,
                         char **override_list,
                         char **params_path_p)
{
  Params = params;
  pirep_spdb2symprod_tdrp_init(Params);
...
int pirep_spdb2symprod_tdrp_load(char *param_file_path,
               pirep_spdb2symprod_tdrp_struct *params,
               char **override_list,
...
/*************************************************************
 * pirep_spdb2symprod_tdrp_load_defaults()
 *
 * Loads up defaults for a given module.
 *
 * See pirep_spdb2symprod_tdrp_load() for more details.
 *
 *  Returns 0 on success, -1 on failure.
 */

int pirep_spdb2symprod_tdrp_load_defaults(pirep_spdb2symprod_tdrp_struct *params,
                        int expand_env)
{
  Params = params;
  pirep_spdb2symprod_tdrp_init(Params);
...
/*************************************************************
 * pirep_spdb2symprod_tdrp_sync()
 *
 * Syncs the user struct data back into the parameter table,
 * in preparation for printing.
 */

void pirep_spdb2symprod_tdrp_sync(void)
{
  tdrpUser2Table(Table, Params);
}

/*************************************************************
 * pirep_spdb2symprod_tdrp_print()
 * 
 * Print params file
 *
...
void pirep_spdb2symprod_tdrp_print(FILE *out, tdrp_print_mode_t mode)
{
  tdrpPrint(out, Table, Module, mode);
}

/*************************************************************
 * pirep_spdb2symprod_tdrp_check_all_set()
 *
...
int pirep_spdb2symprod_tdrp_check_all_set(FILE *out)
{
  return (tdrpCheckAllSet(out, Table, Params));
}

/*************************************************************
 * pirep_spdb2symprod_tdrp_check_is_set()
 *
 * Return TRUE if parameter is set, FALSE if not.
 *
 */

int pirep_spdb2symprod_tdrp_check_is_set(char *param_name)
{
  return (tdrpCheckIsSet(param_name, Table, Params));
}

/*************************************************************
 * pirep_spdb2symprod_tdrp_free_all()
 *
 * Frees up all TDRP dynamic memory.
 */

void pirep_spdb2symprod_tdrp_free_all(void)
{
  tdrpFreeAll(Table, Params);
}

/*************************************************************
 * pirep_spdb2symprod_tdrp_array_realloc()
 *
 * Realloc 1D array.
 *
...
int pirep_spdb2symprod_tdrp_array_realloc(char *param_name, int new_array_n)
{
...
/*************************************************************
 * pirep_spdb2symprod_tdrp_array2D_realloc()
 *
 * Realloc 2D array.
 *
 * If size is increased, the values from the last array entry is
...
int pirep_spdb2symprod_tdrp_array2D_realloc(char *param_name,
                          int new_array_n1,
                          int new_array_n2)
{
...
/*************************************************************
 * pirep_spdb2symprod_tdrp_table()
 *
 * Returns pointer to static Table for this module.
 */

TDRPtable *pirep_spdb2symprod_tdrp_table(void)
{
  return (Table);
}

/*************************************************************
 * pirep_spdb2symprod_tdrp_init()
 *
...
TDRPtable *pirep_spdb2symprod_tdrp_init(pirep_spdb2symprod_tdrp_struct *params)

{

  TDRPtable *tt = Table;

  pirep_spdb2symprod_tdrp_struct pp; /* for computing byte_offsets */

  /* zero out struct, and store size */

  memset(params, 0, sizeof(pirep_spdb2symprod_tdrp_struct));
  params->struct_size = sizeof(pirep_spdb2symprod_tdrp_struct);

  /* Parameter 'debug' */
  /* ctype is 'pirep_spdb2symprod_debug_t' */
  ...
  tt->single_val.s = tdrpStrDup("PIREP");
  tt++;
  ...
  /* Parameter 'plot_callsign' */
  /* ctype is 'tdrp_bool_t' */
  
  memset(tt, 0, sizeof(TDRPtable));
  tt->ptype = BOOL_TYPE;
  tt->param_name = tdrpStrDup("plot_callsign");
  tt->descr = tdrpStrDup("Plot callsign with text.");
  tt->help = tdrpStrDup("If true the callsign is added to the flightlevel for the top line.");
  tt->val_offset = (char *) &(pp.plot_callsign) - (char *) &pp;
  tt->single_val.b = pTRUE;
  tt++;
  ...
  tt->descr = tdrpStrDup("Color for text product.");
  tt->help = tdrpStrDup("Name of color suggested for rendering pirep text.");
  ...
  /* ctype is 'pirep_spdb2symprod_line_type_t' */
  ...
  /* ctype is 'pirep_spdb2symprod_capstyle_t' */
  ...
  /* ctype is 'pirep_spdb2symprod_joinstyle_t' */
