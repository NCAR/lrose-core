...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("TsFmq2Tcp listens for clients. When a client connects, it spawns a child to handle the client. The child opens the time-series FMQ, reads a message at a time from the FMQ and writes this data, unchanged, to the client in a continuous stream.");
    ...
    tt->descr = tdrpStrDup("Path of FMQ.");
    ...
    tt->val_offset = (char *) &fmq_path - &_start_;
