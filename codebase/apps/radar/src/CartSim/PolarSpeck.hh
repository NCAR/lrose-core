...
/**
 * @file  PolarSpeck.hh
 * @brief 'Speck' of outlier data with polar parameters
 * @class  PolarSpeck
 * @brief 'Speck' of outlier data with polar parameters
 */

# ifndef    POLAR_SPECK_H
# define    POLAR_SPECK_H
...
public:
   ...
   * Default constructor
   */
  PolarSpeck(const Params &P, const Params::PolarSpeck_t &mP);
  
  /**
   * Destructor
   */
  virtual ~PolarSpeck(void);
