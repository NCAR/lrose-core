...
#include <cstring>
...

  {
    ...
    tt->comment_hdr = tdrpStrDup("Mdv2Vad reads in Doppler data from an MDV polar radar file, computes volumetric VAD (VVP) winds and writes them out to SPDB.");
    ...
    tt->descr = tdrpStrDup("Is the SNR field available?.");
    tt->help = tdrpStrDup("");
    ...
    tt->comment_text = tdrpStrDup("You have the option to censor gates in the input data based on the value in an input field. Normally SNR is used for this purpose.");
    tt++;
    ...
    tt->comment_hdr = tdrpStrDup("NYQUIST value (m/s)");
    tt->comment_text = tdrpStrDup("");
    tt++;
    ...
    tt->descr = tdrpStrDup("Latitude of radar (deg).");
    tt->help = tdrpStrDup("See override_radar_position.");
    ...
    tt->descr = tdrpStrDup("Longitude of radar (deg).");
    tt->help = tdrpStrDup("See override_radar_position.");
    ...
    tt->comment_hdr = tdrpStrDup("SPDB DATA OUTPUT");
    tt->comment_text = tdrpStrDup("");
    tt++;
    ...
    tt->single_val.s = tdrpStrDup("./output/spdb/vad");
    tt++;
