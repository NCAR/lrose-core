...
public class DisplayInfo {
  ...
  unsigned int getNumFields() { return fields.size(); }
}
 */

SpreadSheet::SpreadSheet(RadxVol &vol, QWidget *parent)
        : QMainWindow(parent)
{
  int rows;
  int cols;
...
void SpreadSheet::createActions()
{
    ...
    connect(cell_MinusFoldRayAction, &QAction::triggered, this, &SpreadSheet::actionMinusFoldRay);
...
void SpreadSheet::setupContents(RadxVol &vol)
{
