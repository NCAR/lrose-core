...
HEADERS += BoundaryPointEditorView.hh
HEADERS += BoundaryPointEditorModel.hh
HEADERS += BoundaryView.hh
HEADERS += BoundaryToolType.hh
...
HEADERS += DisplayFieldView.hh
HEADERS += PpiBeam.hh
HEADERS += PolarManager.hh
HEADERS += PolarWidget.hh
HEADERS += PolygonUtils.hh
HEADERS += RayLoc.hh
HEADERS += RayLocationController.hh
HEADERS += RayLocationModel.hh
HEADERS += Reader.hh
HEADERS += ScaledLabel.hh
HEADERS += SiiPalette.hh
HEADERS += SoloDefaultColorWrapper.hh
HEADERS += StatusPanelController.hh
HEADERS += StatusPanelView.hh
HEADERS += SweepView.hh
...
HEADERS += ClickableLabelNamed.hh
HEADERS += TextEdit.hh
...
HEADERS += BoundaryPointEditorView.cc
HEADERS += BoundaryPointEditorModel.cc
HEADERS += BoundaryView.cc
...
SOURCES += DataModel.cc
SOURCES += FieldRendererView.cc
...
SOURCES += PolarWidget.cc
SOURCES += PpiBeam.cc
SOURCES += RayLocationController.cc
SOURCES += RayLocationModel.cc
SOURCES += Reader.cc
SOURCES += ScaledLabel.cc
SOURCES += SiiPalette.cc
SOURCES += SoloDefaultColorWrapper.cc
SOURCES += SweepView.cc
SOURCES += SweepController.cc
SOURCES += SweepModel.cc
...
SOURCES += ClickableLabelNamed.cc
SOURCES += TextEdit.cc
...
SOURCES += StatusPanelController.cc
SOURCES += StatusPanelView.cc
...
INCLUDEPATH += $(LROSE_INSTALL_DIR)/include
