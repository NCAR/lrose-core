/*************************************************************************
 *
 * $Id: nexrad_structs.h,v 1.1 2007/10/25 03:37:27 dixon Exp $
 *
 *                             nexrad.h
 *
 * 
 ...
 *
 *      $Log: nexrad_structs.h,v $
 *      Revision 1.1  2007/10/25 03:37:27  dixon
 *      Adding BOM rapic server code for building Dsr2Rapic
 *
 *      Revision 1.1.1.1  2003/06/19 01:19:26  pjp
 *      3DRapic Sources
 *
 *      Revision 1.1  1999/08/12 07:14:37  sandy
 *      add NexRad
 *
...
/*
 * static char RCSid[] = "$Id: nexrad_structs.h,v 1.1 2007/10/25 03:37:27 dixon Exp $";
 *
 * static char COPYRIGHTid[] = "Copyright 1994 NCAR.  All Rights Reserved.";
 *
 */

# ifndef _NEXRAD_STRUCTS_H
# define _NEXRAD_STRUCTS_H
...
//this is pinched from ridds2mom.h on ancpc1:ncar/apps/didss/src/ridds2mom
//appears to replace NEXRAD_ctm_info although fr_seq is extra!
typedef struct {
