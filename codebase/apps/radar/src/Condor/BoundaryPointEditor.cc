...
/*
  ...
  Boundary files are written to the user's home directory underneath "/CondorBoundaries". For example,
  to /home/jeff/CondorBoundaries. For each radar file opened and accessed with the Boundary Editor, a
  ...
  something like /home/jeff/CondorBoundaries/1736437357943458505
...
void BoundaryPointEditor::insertPoint(float x, float y)
{
  ...
  // cout << "INSERT POINT! nearestPtIndex="
  //      << nearestPtIndex << ", insert point at "
  //      << x << "," << y << endl;
  // cout << "afterPtDist=" << afterPtDistance
  //      << ", beforePtDist=" << beforePtDistance
  //      << ", beforePtIndex=" << beforePtIndex
  //      << ", afterPtIndex=" << afterPtIndex << endl;
...
void BoundaryPointEditor::save(string path)
{
  ...
  // cout << "BoundaryPointEditor, saving boundary with "
  //      << points.size() << " points to " << path << endl;
...
/*
  boundaryFilePath will be something like "/home/jeff/CondorBoundaries/7996122556911878505/field0-sweep0-Boundary1"
...
/*
  rootBoundaryDir will be something like "/home/jeff/CondorBoundaries" (home directory + "/CondorBoundaries")
  radarFilePath will be something like "/media/sf_lrose/ncswp_SPOL_RHI_.nc"
  returns the boundary dir for this radar file (e.g. "/home/jeff/CondorBoundaries/1736437357943458505")
*/
...
/*
  boundaryDir will be something like "/home/jeff/CondorBoundaries/1736437357943458505" (where "1736437357943458505" is the hash code of the radar source filepath)
  fieldIndex is zero based. E.g., "DBZ" is usually fieldIndex 0, "REF" is fieldIndex 1
  sweepIndex is zero based. E.g., "4.47" might be sweepIndex 0, "3.50" sweepIndex 1, ... "0.47" sweepIndex 4
  boundaryFileName will be one of 5 values ("Boundary1" .. "Boundary5")
*/
