...
%     plot_var(dataDir, 'dbm', 'Power averaged (dBm)','color_axis',[-15 22]);

    plot_var(dataDir, 'dbmHc', 'Power H co-pol (dBm)','color_axis',[-15 22]);
%    plot_var(dataDir, 'dbmHx', 'Power H x-pol (dBm)','color_axis',[-15 22]);
    plot_var(dataDir, 'dbmVc', 'Power V co-pol (dBm)','color_axis',[-15 22]);
%    plot_var(dataDir, 'dbmVx', 'Power V x-pol (dBm)','color_axis',[-15 22]);

%plot_var(dataDir, 'corr00H', 'Correlation H-V, H flag = 1','color_axis',[0 0.25]);
%plot_var(dataDir, 'corr00V', 'Correlation H-V, V flag = 0','color_axis',[0 0.25]);
