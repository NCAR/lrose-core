...
public:
  ...
  int number_of_range_segments;

  double snr_hist_min;

  double snr_hist_max;

  double snr_hist_delta;

  double mode_threshold;

  double tail_threshold;

  double interference_snr_threshold;

  tdrp_bool_t print_histogram;
  ...
  tdrp_bool_t apply_median_filter_to_output_DBZ;

  int DBZ_median_filter_len;

  tdrp_bool_t apply_nexrad_spike_filter;
